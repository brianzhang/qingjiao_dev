...
<script type="text/javascript"
	src="${ctx}/js/lc/platform/org/partyPositionManager.js"></script>
<script type="text/javascript">
	//当前访问系统
...
<body class="gray-bg">
	<div class="ui-layout-west">
			...
			<div class="ui-layout-center">
				<div class="treeFrame">
					<iframe id="listFrame" src="info.htm" frameborder="no" width="100%"
						height="100%"></iframe>
				</div>
			</div>
	<div id="groupMenu" class="bootstrap-contextmenu">
		<ul class="dropdown-menu" role="menu">
			...
			<li class="divider"></li>
	        <li><a data-action="node_move" tabindex="-1">
	        	<i class="fa fa-arrows-v"></i>&nbsp;&nbsp;移动节点</a></li>
		</ul>
	</div>
