...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/org/partyEmployeeUnderList.js"></script>
		<title>员工管理列表</title>
	</head>
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons">
							...
							<a class="btn btn-primary fa fa-add" href="javascript:partyEmployeeUnder.addUnder('${id}');" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-remove" action="${ctx}/platform/org/partyEmployee/removeUnder.htm?userId=${id}" href="javascript:void(0);"><span>移除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
			...
			<div class="jqGrid_wrapper">
				<table id="partyEmployeeUnderGrid" ></table>
				<div id="partyEmployeeUnderPager"></div>
			</div>
		</div>
	</body>
</html>