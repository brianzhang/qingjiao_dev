...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/org/regData.js"></script>
		<title>用户注册信息管理列表</title>
	</head>
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
						...
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								<div class="form-group">
									...
									<input type="text"  name="Q^FULL_NAME_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">手机</label>:
									<input type="text"  name="Q^MOBILE_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">公司名称</label>:
									<input type="text"  name="Q^COMPANY_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
			...
			<div class="jqGrid_wrapper">
				<table id="regDataGrid" ></table>
				<div id="regDataPager"></div>
			</div>
		</div>
