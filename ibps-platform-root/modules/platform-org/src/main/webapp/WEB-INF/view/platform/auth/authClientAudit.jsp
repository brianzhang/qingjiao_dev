...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
				<form  class="fr-form"  id="authClientAuditForm" action="doAudit.htm" >
					...
					<input type="hidden" name="m:authClient:createTime"  value="<fmt:formatDate value="${authClient.createTime}"  pattern="yyyy-MM-dd"/>"/>
					<input type="hidden" name="m:authClient:auditBy"  value="${authClient.auditBy}"/>
					<input type="hidden" name="m:authClient:auditTime"  value="<fmt:formatDate value="${authClient.auditTime}"  pattern="yyyy-MM-dd"/>"/>
					<input type="hidden" name="m:authClient:cause" id="cause" value="${authClient.cause}"/>
				 	<div class="fr_response_field col-sm-6" >
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">第三方标识</label>
						  	<div class="fr-form-block">
						<input type="text" class="fr-form-control" readonly name="m:authClient:clientKey" value="${authClient.clientKey}" validate="{required:false}"/>
						 	</div>
					  	</div>
					</div>
					 <div class="fr_response_field col-sm-6" >
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">第三方名称</label>
						  	<div class="fr-form-block">
						<input type="text" class="fr-form-control" readonly name="m:authClient:clientName" value="${authClient.clientName}" validate="{required:false}"/>
						 	</div>
					  	</div>
					</div>
					 <div class="fr_response_field col-sm-6" >
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">第三方Domain</label>
						  	<div class="fr-form-block">
						<input type="text" class="fr-form-control" readonly name="m:authClient:clientUri" value="${authClient.clientUri}" validate="{required:false}"/>
						 	</div>
					  	</div>
					</div>
					<div class="fr_response_field col-sm-6" >
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">密钥</label>
						  	<div class="fr-form-block">
						<input type="text" class="fr-form-control" readonly name="m:authClient:clientSecret" value="${authClient.clientSecret}" validate="{required:false}"/>
						 	</div>
					  	</div>
					</div>
					 <div class="fr_response_field col-sm-6" >
						 	...
						 	<label class="fr-control-label">作用域</label>
						  	<div class="fr-form-block">
						  		...
						  		<label class="checkbox-inline">
                               	 	<input type="checkbox" disabled class="ibps" value="${scope.value }" 
					 	...
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">授权类型</label>
						  	<div class="fr-form-block">
						  		...
						  		<label class="checkbox-inline">
                               	 	<input type="checkbox" disabled class="ibps" value="${grantType.value }" 
					...
					<div class="fr_response_field col-sm-12" >
					 	<div class="fr-form-group"> 
						 	<label class="fr-control-label">描述</label>
						  	<div class="fr-form-block">
						<input type="text" class="fr-form-control" readonly name="m:authClient:clientDesc" value="${authClient.clientDesc}" validate="{required:false}"/>
						 	</div>
					  	</div>
					</div>
				</form>
