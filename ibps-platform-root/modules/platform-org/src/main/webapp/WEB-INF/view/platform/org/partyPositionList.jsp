		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			<div  class="toolbar-panel ">
					<div class="toolbar-box">
						<div class="toolbar-head clearfix">
							...
							<div class="buttons"> 		
								...
								<a class="btn btn-primary fa fa-add"   href="${ctx}/platform/org/partyPosition/edit.htm" ><span>添加</span></a>
						        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/platform/org/partyPosition/edit.htm" ><span>编辑</span></a>	 
				...
				<div class="jqGrid_wrapper">
					<table id="partyPositionGrid" ></table>
					<div id="partyPositionPager"></div>
				</div>
		</div>
