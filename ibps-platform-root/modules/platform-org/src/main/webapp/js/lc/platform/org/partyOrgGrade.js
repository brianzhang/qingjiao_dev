 ...
 */
$(function() {
	var partyOrgGrade = new PartyOrgGrade();
	partyOrgGrade.init();
});
...
(function() {
	//定义常量
	var _consts = {
		GRID : "#partyOrgGradeGrid",// 列表对象
		PAGER : "#partyOrgGradePager",// 列表分页
		FORM : '#partyOrgGradeForm'// 表单form
	};
	/**
	 * 参与者 对象
	 * @returns {PartyOrgGrade}
	 */
	PartyOrgGrade = function() {
		//定义属性
	};
		...
		_initGridList : function() {
			...
			$(this.consts.GRID)
					.GridList(
							{
								url : __ctx
										+ '/platform/org/partyOrg/listJsonByGrade.htm',
		...
		_showResponse : function(responseText) {
			...
			if (msg.isSuccess()) {
				DialogUtil.msg(msg.getMessage(), function(rtn) {
					//刷新左边的树
					parent.partyOrgGradeManager.loadTree();
