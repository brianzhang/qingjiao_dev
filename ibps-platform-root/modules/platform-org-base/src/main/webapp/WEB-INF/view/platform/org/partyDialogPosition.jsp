...
<script type="text/javascript" src="${ctx}/js/lc/platform/org/partyDialogPosition.js"></script>
			...
			<div class="tab-content">
					...
					<div class="panel-body p-t-0">
						<div class="wrapper wrapper-content animated fadeInRight">
							<div class="tree-toolbar" style="height: 45px;">
								 ...
								 <label>
								 	<input type="text" id="qPosName" class="form-control input-s-sm"/>
								 </label>
							...
							<div id="partyPositionTree" class="ztree"></div>
						</div>
					</div>
				</div>
				<div id="tab-2" class="tab-pane">
					<div class="panel-body">
						<div class="wrapper wrapper-content animated fadeInRight">
							<div class="row">
								<table id="tbl_myself" width="100%">
									<c:forEach items="${posList }" var="pos">
										<tr align="center">
											<td><input type="checkbox" value="${pos.id},${pos.name },${pos.posAlias }"/></td>
