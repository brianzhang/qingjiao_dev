...
<html>
	...
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<%-- 					<a class="btn btn-primary fa fa-send"     href="${ctx}/platform/msg/innerMessage/send.htm"><span>发送消息</span></a> --%>
							</div>
							<!-- 收缩 -->
							<div class="tools">
						...
						<div class="toolbar-body" >
							<form role="form" class="search-form">
									<div  class="form-inline p-xxs">
										...
										<div class="form-group">
											<label   class="search-label">发送人</label>:
											<input type="text"  name="Q^owner_^SL"  class="form-control"  />
										</div> 
										<div class="form-group">
											<label   class="search-label">消息类型</label>:
												<select name="Q^message_type_^SL"  class="form-control search-select" >
				...
				<div class="jqGrid_wrapper">
					<table id="innerMessageSentGrid" ></table>
