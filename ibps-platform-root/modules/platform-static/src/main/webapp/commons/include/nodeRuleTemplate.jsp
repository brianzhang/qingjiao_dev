...
<div style="display:none;"> 
		...
		<div id="role-div">
			...
			<a  href="javascript:void(0);" class="link role">选择</a>
		</div>
		<div id="position-div">
			<input type="hidden" value="">
			<input type="text" readonly="readonly" />
			<a  href="javascript:void(0);" class="link position">选择</a>
		</div>
		<div id="org-div">
			<input type="hidden" value="">
			<input type="text" readonly="readonly" />
			<a  href="javascript:void(0);" class="link org">选择</a>
		</div>
		<div id="user-div">
			<input type="hidden" value="">
			<input type="text" readonly="readonly" />
			<a  href="javascript:void(0);" class="link users">选择</a>
		</div>
		<input type="text" name="paramValue" id="paramValue" class="left margin-set"  validateVal/>
		<!-- 属性模板 -->
		<select id="paramKey" name="paramKey"  class="left margin-set " >
		...
		<c:when test="${attribute.sourceType eq 'select'}">
			<select validateVal name="paramValue" class="left margin-set">
		...
		<input type="text" name="paramValue" class="left margin-set" validateVal/>
		</c:when>
		...
		<input type="text" id="paramValue" name="paramValue" class="left margin-set" validateVal/>
		...
		<div >
			<table id="condition-script-rule">
				<tr class="script-tr">
					...
					<td>
						<a name="script"  href="javascript:void(0);" onclick="editConditionScript(this)">脚本</a>
					</td>
				</tr>
			</table>
		</div>
