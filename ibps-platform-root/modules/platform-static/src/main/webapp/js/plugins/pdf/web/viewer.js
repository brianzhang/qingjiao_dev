...
e.GrabToPan=t}),function(e,t){t(e.pdfjsWebOverlayManager={})}(this,function(e){var t={overlays:{},active:null,register:function(e,t,i,n){return new Promise(function(s){var r
...
if(0===s)return!1
for(var r=0;s>r;++r){var a=n[r].view
if(!this.isViewFinished(a))return a}if(i){var o=e.last.id
if(t[o]&&!this.isViewFinished(t[o]))return t[o]}else{var h=e.first.id-2
if(t[h]&&!this.isViewFinished(t[h]))return t[h]}return null},isViewFinished:function(e){return e.renderingState===i.FINISHED},renderView:function(e){var t=e.renderingState
...
s._writeToStorage=function(e){return new Promise(function(t){localStorage.setItem("pdfjs.preferences",JSON.stringify(e)),t()})},s._readFromStorage=function(e){return new Promise(function(e){var t=JSON.parse(localStorage.getItem("pdfjs.preferences"))
e(t)})},e.Preferences=s}),function(e,t){t(e.pdfjsWebViewHistory={})}(this,function(e){var t=20,i=function(){function e(e,i){this.fingerprint=e,this.cacheSize=i||t,this.isInitializedPromiseResolved=!1,this.initializedPromise=this._readFromStorage().then(function(e){this.isInitializedPromiseResolved=!0
var t=JSON.parse(e||"{}")
...
if(i)try{var n=JSON.parse(i)
"string"==typeof n.files[0].fingerprint&&(localStorage.setItem("pdfjs.history",i),localStorage.removeItem("database"),t=i)}catch(s){}}e(t)})},set:function(e,t){return this.isInitializedPromiseResolved?(this.file[e]=t,this._writeToStorage()):void 0},setMultiple:function(e){if(this.isInitializedPromiseResolved){for(var t in e)this.file[t]=e[t]
...
i(s,n)}},e.DownloadManager=n}),function(e,t){t(e.pdfjsWebPDFAttachmentViewer={},e.pdfjsWebPDFJS)}(this,function(e,t){var i=function(){function e(e){this.attachments=null,this.container=e.container,this.eventBus=e.eventBus,this.downloadManager=e.downloadManager}return e.prototype={reset:function(){this.attachments=null
...
n=s.length
for(var r=0;n>r;r++){var a=i[s[r]],o=t.getFilenameFromUrl(a.filename),h=document.createElement("div")
...
e.PDFAttachmentViewer=i}),function(e,t){t(e.pdfjsWebPDFOutlineViewer={},e.pdfjsWebPDFJS)}(this,function(e,t){var i=t.PDFJS,n="–",s=function(){function e(e){this.outline=null,this.lastToggleIsShow=!0,this.container=e.container,this.linkService=e.linkService,this.eventBus=e.eventBus}return e.prototype={reset:function(){this.outline=null,this.lastToggleIsShow=!0
...
if(r&&r.renderingState===i.FINISHED){var a=t.getThumbnail(s)
a.setImage(r)}}t.scrollThumbnailIntoView(e.currentPageNumber)},_addEventListeners:function(){var e=this
...
for(var s=i||!1,r=e.offsetTop+e.clientTop,a=e.offsetLeft+e.clientLeft;n.clientHeight===n.scrollHeight||s&&"hidden"===getComputedStyle(n).overflow;)if(n.dataset._scaleY&&(r/=n.dataset._scaleY,a/=n.dataset._scaleX),r+=n.offsetTop,a+=n.offsetLeft,n=n.offsetParent,!n)return
...
return e.addEventListener("scroll",i,!0),n}function r(e){for(var t=e.split("&"),i={},n=0,s=t.length;s>n;++n){var r=t[n].split("="),a=r[0].toLowerCase(),o=r.length>1?r[1]:null
...
t(r)?n=s:i=s+1}return i}function o(e){if(Math.floor(e)===e)return[e,1]
var t=1/e,i=8
if(t>i)return[1,i]
if(Math.floor(t)===t)return[1,t]
for(var n=e>1?t:e,s=0,r=1,a=1,o=1;;){var h=s+a,d=r+o
if(d>i)break
h/d>=n?(a=h,o=d):(s=h,r=d)}var c
return c=a/o-n>n-s/r?n===e?[s,r]:[r,s]:n===e?[a,o]:[o,a]}function h(e,t){var i=e%t
return 0===i?e:Math.round(e-i+t)}function d(e,t,i){function n(e){var t=e.div,i=t.offsetTop+t.clientTop+t.clientHeight
return i>f}for(var s,r,o,h,d,c,l,u,f=e.scrollTop,g=f+e.clientHeight,p=e.scrollLeft,v=p+e.clientWidth,m=[],b=0===t.length?0:a(t,n),w=b,P=t.length;P>w&&(s=t[w],r=s.div,o=r.offsetTop+r.clientTop,h=r.clientHeight,!(o>g));w++)l=r.offsetLeft+r.clientLeft,u=r.clientWidth,p>l+u||l>v||(d=Math.max(0,f-o)+Math.max(0,o+h-g),c=100*(h-d)/h|0,m.push({id:s.id,x:l,y:o,view:s,percent:c}))
...
var n=0,s=1,r=30,a=30
return e.deltaMode===n?t/=r*a:e.deltaMode===s&&(t/=a),t}var f=96/72,g="auto",p=1,v=.25,m=10,b=0,w=1.25,P=40,y=5,S={CANVAS:"canvas",SVG:"svg"},L=document.mozL10n||document.webL10n,C=t.PDFJS
C.disableFullscreen=void 0===C.disableFullscreen?!1:C.disableFullscreen,C.useOnlyCssZoom=void 0===C.useOnlyCssZoom?!1:C.useOnlyCssZoom,C.maxCanvasPixels=void 0===C.maxCanvasPixels?16777216:C.maxCanvasPixels,C.disableHistory=void 0===C.disableHistory?!1:C.disableHistory,C.disableTextLayer=void 0===C.disableTextLayer?!1:C.disableTextLayer,C.ignoreCurrentPositionOnZoom=void 0===C.ignoreCurrentPositionOnZoom?!1:C.ignoreCurrentPositionOnZoom,C.locale=void 0===C.locale?navigator.language:C.locale
var I=new Promise(function(e){window.requestAnimationFrame(e)}),_=new Promise(function(e,t){return L?"loading"!==L.getReadyState()?void e():void window.addEventListener("localized",function(t){e()}):void e()}),B=function(){function e(){this._listeners=Object.create(null)}return e.prototype={on:function(e,t){var i=this._listeners[e]
...
t.slice(0).forEach(function(e){e.apply(null,i)})}}},e}(),E=function(){function e(e,t,i){return Math.min(Math.max(e,t),i)}function t(e,t){this.visible=!0,this.div=document.querySelector(e+" .progress"),this.bar=this.div.parentNode,this.height=t.height||100,this.width=t.width||100,this.units=t.units||"%",this.div.style.height=this.height+this.units,this.percent=0}return t.prototype={updateBar:function(){if(this._indeterminate)return this.div.classList.add("indeterminate"),void(this.div.style.width=this.width+this.units)
...
e.CSS_UNITS=f,e.DEFAULT_SCALE_VALUE=g,e.DEFAULT_SCALE=p,e.MIN_SCALE=v,e.MAX_SCALE=m,e.UNKNOWN_SCALE=b,e.MAX_AUTO_SCALE=w,e.SCROLLBAR_PADDING=P,e.VERTICAL_PADDING=y,e.RendererType=S,e.mozL10n=L,e.EventBus=B,e.ProgressBar=E,e.getPDFFileNameFromURL=l,e.noContextMenuHandler=c,e.parseQueryString=r,e.getVisibleElements=d,e.roundToDivide=h,e.approximateFraction=o,e.getOutputScale=i,e.scrollIntoView=n,e.watchScroll=s,e.binarySearchFirstItem=a,e.normalizeWheelEventDelta=u,e.animationStarted=I,e.localized=_}),function(e,t){t(e.pdfjsWebDOMEvents={},e.pdfjsWebUIUtils)}(this,function(e,t){function i(e){e.on("documentload",function(){var e=document.createEvent("CustomEvent")
...
if(t)return 1024>t?s.get("document_properties_kb",{size_kb:(+t.toPrecision(3)).toLocaleString(),size_b:e.toLocaleString()},"{{size_kb}} KB ({{size_b}} bytes)"):s.get("document_properties_mb",{size_mb:(+(t/1024).toPrecision(3)).toLocaleString(),size_b:e.toLocaleString()},"{{size_mb}} MB ({{size_b}} bytes)")},_parseDate:function(e){var t=e
if(void 0===t)return""
...
e.PDFDocumentProperties=a}),function(e,t){t(e.pdfjsWebPDFFindController={},e.pdfjsWebUIUtils)}(this,function(e,t){var i=t.scrollIntoView,n={FIND_FOUND:0,FIND_NOTFOUND:1,FIND_WRAPPED:2,FIND_PENDING:3},s=-50,r=-400,a={"‘":"'","’":"'","‚":"'","‛":"'","“":'"',"”":'"',"„":'"',"‟":'"',"¼":"1/4","½":"1/2","¾":"3/4"},o=function(){function e(e){this.pdfViewer=e.pdfViewer||null,this.onUpdateResultsCount=null,this.onUpdateState=null,this.reset()
var t=Object.keys(a).join("")
this.normalizationRegex=RegExp("["+t+"]","g")}return e.prototype={reset:function(){this.startedTextExtraction=!1,this.extractTextPromises=[],this.pendingFindMatches=Object.create(null),this.active=!1,this.pageContents=[],this.pageMatches=[],this.pageMatchesLength=null,this.matchCount=0,this.selected={pageIdx:-1,matchIdx:-1},this.offset={pageIdx:null,matchIdx:null},this.pagesToSearch=null,this.resumePageIdx=null,this.state=null,this.dirtyMatch=!1,this.findTimeout=null,this.firstPagePromise=new Promise(function(e){this.resolveFirstPage=e}.bind(this))},normalize:function(e){return e.replace(this.normalizationRegex,function(e){return a[e]})},_prepareMatches:function(e,t,i){function n(e,t){var i,n,s
...
n.push(r)}this.pageMatches[t]=n},calcFindWordMatch:function(e,t,i){for(var n,s,r,a=[],o=e.match(/\S+/g),h=0,d=o.length;d>h;h++)for(n=o[h],s=n.length,r=-s;;){if(r=i.indexOf(n,r+s),-1===r)break
a.push({match:r,matchLength:s,skipped:!1})}this.pageMatchesLength||(this.pageMatchesLength=[]),this.pageMatchesLength[t]=[],this.pageMatches[t]=[],this._prepareMatches(a,this.pageMatches[t],this.pageMatchesLength[t])},calcFindMatch:function(e){var t=this.normalize(this.pageContents[e]),i=this.normalize(this.state.query),n=this.state.caseSensitive,s=this.state.phraseSearch,r=i.length
0!==r&&(n||(t=t.toLowerCase(),i=i.toLowerCase()),s?this.calcFindPhraseMatch(i,e,t):this.calcFindWordMatch(i,e,t),this.updatePage(e),this.resumePageIdx===e&&(this.resumePageIdx=null,this.nextPageMatch()),this.pageMatches[e].length>0&&(this.matchCount+=this.pageMatches[e].length,this.updateUIResultsCount()))},extractText:function(){function e(i){s.pdfViewer.getPageTextContent(i).then(function(n){for(var r=n.items,a=[],o=0,h=r.length;h>o;o++)a.push(r[o].str)
...
return i?(this.hadMatch=!0,t.matchIdx=n?i-1:0,this.updateMatch(!0),!0):(this.advanceOffsetPage(n),t.wrapped&&(t.matchIdx=null,this.pagesToSearch<0)?(this.updateMatch(!1),!0):!1)},updateMatchPosition:function(e,t,n,a){if(this.selected.matchIdx===t&&this.selected.pageIdx===e){var o={top:s,left:r}
i(n[a],o,!0)}},nextPageMatch:function(){null!==this.resumePageIdx&&console.error("There can only be one pending page.")
...
e.FindStates=n,e.PDFFindController=o}),function(e,t){t(e.pdfjsWebPDFPresentationMode={},e.pdfjsWebUIUtils)}(this,function(e,t){var i=t.normalizeWheelEventDelta,n=1500,s=3e3,r="pdfPresentationMode",a="pdfPresentationModeControls",o=function(){function e(e){this.container=e.container,this.viewer=e.viewer||e.container.firstElementChild,this.pdfViewer=e.pdfViewer,this.eventBus=e.eventBus
...
var t=i(e),n=50,s=.1,r=(new Date).getTime(),a=this.mouseScrollTimeStamp
if(!(r>a&&n>r-a)&&((this.mouseScrollDelta>0&&0>t||this.mouseScrollDelta<0&&t>0)&&this._resetMouseScrollState(),this.mouseScrollDelta+=t,Math.abs(this.mouseScrollDelta)>=s)){var o=this.mouseScrollDelta
this._resetMouseScrollState()
var h=o>0?this._goToPreviousPage():this._goToNextPage()
h&&(this.mouseScrollTimeStamp=r)}}},get isFullscreen(){return!!(document.fullscreenElement||document.mozFullScreen||document.webkitIsFullScreen||document.msFullscreenElement)},_goToPreviousPage:function(){var e=this.pdfViewer.currentPageNumber
...
s.id=e,s.className=t,s.setAttribute("aria-label",i),s.style.width=this.canvasWidth+"px",s.style.height=this.canvasHeight+"px",s.src=this.canvas.toDataURL(),this.image=s,this.div.setAttribute("data-loaded",!0),this.ring.appendChild(s),this.canvas.width=0,this.canvas.height=0,delete this.canvas}},draw:function(){function e(e){return c===s.renderTask&&(s.renderTask=null),"cancelled"===e?void i(e):(s.renderingState=r.FINISHED,s._convertCanvasToImage(),void(e?i(e):t(void 0)))}if(this.renderingState!==r.INITIAL)return console.error("Must be in new state before drawing"),Promise.resolve(void 0)
this.renderingState=r.RUNNING
var t,i,n=new Promise(function(e,n){t=e,i=n}),s=this,a=this._getPageDrawContext(),o=this.viewport.clone({scale:this.scale}),h=function(e){return s.renderingQueue.isHighestPriority(s)?void e():(s.renderingState=r.PAUSED,void(s.resume=function(){s.renderingState=r.RUNNING,e()}))},d={canvasContext:a,viewport:o},c=this.renderTask=this.pdfPage.render(d)
...
for(var a=3,o=s.width<<a,h=s.height<<a,d=e(o,h),c=d.getContext("2d");o>i.width||h>i.height;)o>>=1,h>>=1
for(c.drawImage(i,0,0,i.width,i.height,0,0,o,h);o>2*s.width;)c.drawImage(d,0,0,o,h,0,0,o>>1,h>>1),o>>=1,h>>=1
n.drawImage(d,0,0,o,h,0,0,s.width,s.height),this._convertCanvasToImage()}}},get pageId(){return null!==this.pageLabel?this.pageLabel:this.id},setPageLabel:function(e){if(this.pageLabel="string"==typeof e?e:null,this.anchor.title=n.get("thumb_page_title",{page:this.pageId},"Page {{page}}"),this.renderingState===r.FINISHED){var t=n.get("thumb_page_canvas",{page:this.pageId},"Thumbnail of Page {{page}}")
...
e.SecondaryToolbar=s}),function(e,t){t(e.pdfjsWebToolbar={},e.pdfjsWebUIUtils)}(this,function(e,t){var i=t.mozL10n,n=t.noContextMenuHandler,s=t.animationStarted,r=t.localized,a=t.DEFAULT_SCALE_VALUE,o=t.DEFAULT_SCALE,h=t.MIN_SCALE,d=t.MAX_SCALE,c="visiblePageIsLoading",l=8,u=22,f=function(){function e(e,t,i){this.toolbar=e.container,this.mainContainer=t,this.eventBus=i,this.items=e,this._wasLocalized=!1,this.reset(),this._bindListeners()}return e.prototype={setPageNumber:function(e,t){this.pageNumber=e,this.pageLabel=t,this._updateUIState(!1)},setPagesCount:function(e,t){this.pagesCount=e,this.hasPageLabels=t,this._updateUIState(!0)},setPageScale:function(e,t){this.pageScaleValue=e,this.pageScale=t,this._updateUIState(!1)},reset:function(){this.pageNumber=0,this.pageLabel=null,this.hasPageLabels=!1,this.pagesCount=0,this.pageScaleValue=a,this.pageScale=o,this._updateUIState(!0)},_bindListeners:function(){var e=this.eventBus,t=this,i=this.items
i.previous.addEventListener("click",function(){e.dispatch("previouspage")}),i.next.addEventListener("click",function(){e.dispatch("nextpage")}),i.zoomIn.addEventListener("click",function(){e.dispatch("zoomin")}),i.zoomOut.addEventListener("click",function(){e.dispatch("zoomout")}),i.pageNumber.addEventListener("click",function(){this.select()}),i.pageNumber.addEventListener("change",function(){e.dispatch("pagenumberchanged",{source:t,value:this.value})}),i.scaleSelect.addEventListener("change",function(){"custom"!==this.value&&e.dispatch("scalechanged",{source:t,value:this.value})}),i.presentationModeButton.addEventListener("click",function(t){e.dispatch("presentationmode")}),i.openFile.addEventListener("click",function(t){e.dispatch("openfile")}),i.print.addEventListener("click",function(t){e.dispatch("print")}),i.download.addEventListener("click",function(t){e.dispatch("download")}),i.scaleSelect.oncontextmenu=n,r.then(this._localized.bind(this))},_localized:function(){this._wasLocalized=!0,this._adjustScaleWidth(),this._updateUIState(!0)},_updateUIState:function(e){function t(e,t){for(var n=a.scaleSelect.options,s=!1,r=0,o=n.length;o>r;r++){var h=n[r]
h.value===e?(h.selected=!0,s=!0):h.selected=!1}if(!s){var d=Math.round(1e4*t)/100
a.customScaleOption.textContent=i.get("page_scale_percent",{scale:d},"{{scale}}%"),a.customScaleOption.selected=!0}}if(this._wasLocalized){var n=this.pageNumber,s=""+(this.pageScaleValue||this.pageScale),r=this.pageScale,a=this.items,o=this.pagesCount
e&&(this.hasPageLabels?a.pageNumber.type="text":(a.pageNumber.type="number",a.numPages.textContent=i.get("of_pages",{pagesCount:o},"of {{pagesCount}}")),a.pageNumber.max=o),this.hasPageLabels?(a.pageNumber.value=this.pageLabel,a.numPages.textContent=i.get("page_of_pages",{pageNumber:n,pagesCount:o},"({{pageNumber}} of {{pagesCount}})")):a.pageNumber.value=n,a.previous.disabled=1>=n,a.next.disabled=n>=o,a.zoomOut.disabled=h>=r,a.zoomIn.disabled=r>=d,t(s,r)}},updateLoadingIndicatorState:function(e){var t=this.items.pageNumber
e?t.classList.add(c):t.classList.remove(c)},_adjustScaleWidth:function(){var e=this.items.scaleSelectContainer,t=this.items.scaleSelect
...
this.previousHash!==i&&(this.allowHashChange=!1),this.previousHash=i,this.historyUnlocked=!0}},back:function(){this.go(-1)},forward:function(){this.go(1)},go:function(e){if(this.initialized&&this.historyUnlocked){var t=window.history.state;-1===e&&t&&t.uid>0?window.history.back():1===e&&t&&t.uid<this.uid-1&&window.history.forward()}}},e.PDFHistory=i}),function(e,t){t(e.pdfjsWebPDFLinkService={},e.pdfjsWebUIUtils,e.pdfjsWebDOMEvents)}(this,function(e,t,i){function n(e){return r.test(e)}var s=t.parseQueryString,r=/^\d+$/,a=function(){function e(e){e=e||{},this.eventBus=e.eventBus||i.getGlobalEventBus(),this.baseUrl=null,this.pdfDocument=null,this.pdfViewer=null,this.pdfHistory=null,this._pagesRefCache=null}function t(e){if(!(e instanceof Array))return!1
var t=e.length,i=!0
if(2>t)return!1
var n=e[0]
...
i=!1
break
default:return!1}for(var r=2;t>r;r++){var a=e[r]
...
r=t+1}if(r){if(1>r||r>n.pagesCount)return void console.error('PDFLinkService_navigateTo: "'+r+'" is a non-existent page number.')
...
"string"==typeof e?(i=e,t=this.pdfDocument.getDestination(e)):t=Promise.resolve(e),t.then(function(t){return e=t,t instanceof Array?void s(t[0]):void console.error('PDFLinkService_navigateTo: "'+t+'" is not a valid destination array.')})},getDestinationHash:function(e){if("string"==typeof e)return this.getAnchorUrl("#"+(n(e)?"nameddest=":"")+escape(e))
...
try{r=JSON.parse(r),r instanceof Array||(r=""+r)}catch(c){}if("string"==typeof r||t(r))return this.pdfHistory&&this.pdfHistory.updateNextHashParam(r),void this.navigateTo(r)
...
e.PDFLinkService=a,e.SimpleLinkService=o}),function(e,t){t(e.pdfjsWebPDFPageView={},e.pdfjsWebUIUtils,e.pdfjsWebPDFRenderingQueue,e.pdfjsWebDOMEvents,e.pdfjsWebPDFJS)}(this,function(e,t,i,n,s){var r=t.CSS_UNITS,a=t.DEFAULT_SCALE,o=t.getOutputScale,h=t.approximateFraction,d=t.roundToDivide,c=t.RendererType,l=i.RenderingStates,u=200,f=function(){function e(e){var t=e.container,i=e.id,s=e.scale,r=e.defaultViewport,o=e.renderingQueue,h=e.textLayerFactory,d=e.annotationLayerFactory,u=e.enhanceTextSelection||!1,f=e.renderInteractiveForms||!1
...
var o=this.viewport.rotation-this.paintedViewportMap.get(e).rotation,h=Math.abs(o),d=1,c=1;(90===h||270===h)&&(d=r/n,c=n/r)
var l="rotate("+o+"deg) scale("+d+","+c+")"
if(i.setProp("transform",e,l),this.textLayer){var u=this.textLayer.viewport,f=this.viewport.rotation-u.rotation,g=Math.abs(f),p=n/u.width;(90===g||270===g)&&(p=n/u.height)
...
var a=null
this.renderingQueue&&(a=function(t){return e.renderingQueue.isHighestPriority(e)?void t():(e.renderingState=l.PAUSED,void(e.resume=function(){e.renderingState=l.RUNNING,t()}))})
...
var d=h.promise.then(function(){return o(null).then(function(){r&&t.getTextContent({normalizeWhitespace:!0}).then(function(e){r.setTextContent(e),r.render(u)})})},function(e){return o(e)})
...
return L.onContinue=function(e){f(),a.onRenderContinue?a.onRenderContinue(e):e()},L.promise.then(function(){f(),t(void 0)},function(e){f(),i(e)}),a},paintOnSvg:function(e){var t=!1,i=function(){if(t)throw"cancelled"},n=this,a=this.pdfPage,o=s.SVGGraphics,h=this.viewport.clone({scale:r}),d=a.getOperatorList().then(function(t){i()
var s=new o(a.commonObjs,a.objs)
return s.getSVG(t,h).then(function(t){i(),n.svg=t,n.paintedViewportMap.set(t,h),t.style.width=e.style.width,t.style.height=e.style.height,n.renderingState=l.FINISHED,e.appendChild(t)})})
return{promise:d,onRenderContinue:function(e){e()},cancel:function(){t=!0}}},setPageLabel:function(e){this.pageLabel="string"==typeof e?e:null,null!==this.pageLabel?this.div.setAttribute("data-page-label",this.pageLabel):this.div.removeAttribute("data-page-label")}},e}()
e.PDFPageView=f}),function(e,t){t(e.pdfjsWebPDFThumbnailViewer={},e.pdfjsWebUIUtils,e.pdfjsWebPDFThumbnailView)}(this,function(e,t,i){var n=t.watchScroll,s=t.getVisibleElements,r=t.scrollIntoView,a=i.PDFThumbnailView,o=-19,h=function(){function e(e){this.container=e.container,this.renderingQueue=e.renderingQueue,this.linkService=e.linkService,this.scroll=n(this.container,this._scrollUpdated.bind(this)),this._resetView()}return e.prototype={_scrollUpdated:function(){this.renderingQueue.renderHighestPriority()},getThumbnail:function(e){return this.thumbnails[e]},_getVisibleThumbs:function(){return s(this.container,this.thumbnails)},scrollThumbnailIntoView:function(e){var t=document.querySelector(".thumbnail.selected")
...
if(!e)return o
for(var h=0,d=e.length;d>h;h++){for(var c=e[h];i!==r&&c>=n+s[i].str.length;)n+=s[i].str.length,i++
...
return d.className=r,d.appendChild(h),void a.appendChild(d)}a.appendChild(h)}if(0!==e.length){var n=this.textContent.items,s=this.textDivs,r=null,a=this.pageIdx,o=null===this.findController?!1:a===this.findController.selected.pageIdx,h=null===this.findController?-1:this.findController.selected.matchIdx,d=null===this.findController?!1:this.findController.state.highlightAll,c={divIdx:-1,offset:void 0},l=h,u=l+1
if(d)l=0,u=e.length
else if(!o)return
for(var f=l;u>f;f++){var g=e[f],p=g.begin,v=g.end,m=o&&f===h,b=m?" selected":""
...
for(var w=p.divIdx+1,P=v.divIdx;P>w;w++)s[w].className="highlight middle"+b
t(v,"highlight end"+b)}r=v}r&&i(r.divIdx,r.offset,c.offset)}},updateMatches:function(){if(this.renderingDone){for(var e=this.matches,t=this.textDivs,i=this.textContent.items,n=-1,s=0,r=e.length;r>s;s++){for(var a=e[s],o=Math.max(n,a.begin.divIdx),h=o,d=a.end.divIdx;d>=h;h++){var c=t[h]
...
s.style.top=(100*o).toFixed(2)+"%"}s.classList.add("active")}}),e.addEventListener("mouseup",function(n){if(t.enhanceTextSelection&&t.textLayerRenderTask)return void(i=setTimeout(function(){t.textLayerRenderTask&&t.textLayerRenderTask.expandTextDivs(!1),i=null},s))
var r=e.querySelector(".endOfContent")
r&&(r.style.top="",r.classList.remove("active"))})}},e}()
n.prototype={createTextLayerBuilder:function(e,t,i,n){return new r({textLayerDiv:e,pageIndex:t,viewport:i,enhanceTextSelection:n})}},e.TextLayerBuilder=r,e.DefaultTextLayerFactory=n}),function(e,t){t(e.pdfjsWebAnnotationLayerBuilder={},e.pdfjsWebUIUtils,e.pdfjsWebPDFLinkService,e.pdfjsWebPDFJS)}(this,function(e,t,i,n){function s(){}var r=t.mozL10n,a=i.SimpleLinkService,o=function(){function e(e){this.pageDiv=e.pageDiv,this.pdfPage=e.pdfPage,this.renderInteractiveForms=e.renderInteractiveForms,this.linkService=e.linkService,this.downloadManager=e.downloadManager,this.div=null}return e.prototype={render:function(e,t){var i=this,s={intent:void 0===t?"display":t}
...
i>=0&&(t=i+1)}this.currentPageNumber=t},get currentScale(){return this._currentScale!==d?this._currentScale:g},set currentScale(e){if(isNaN(e))throw Error("Invalid numeric scale")
return this.pdfDocument?void this._setScale(e,!1):(this._currentScale=e,void(this._currentScaleValue=e!==d?""+e:null))},get currentScaleValue(){return this._currentScaleValue},set currentScaleValue(e){return this.pdfDocument?void this._setScale(e,!1):(this._currentScale=isNaN(e)?d:e,void(this._currentScaleValue=""+e))},get pagesRotation(){return this._pagesRotation},set pagesRotation(e){if("number"!=typeof e||e%90!==0)throw Error("Invalid pages rotation angle.")
...
return this.firstPagePromise=c,c.then(function(s){for(var r=this.currentScale,a=s.getViewport(r*f),c=1;i>=c;++c){var l=null
...
r.pdfPage||r.setPdfPage(i),g.cachePageRef(e,i.ref),s--,s||t()}.bind(null,r))}),n.eventBus.dispatch("pagesinit",{source:n}),this.defaultRenderingQueue&&this.update(),this.findController&&this.findController.resolveFirstPage()}.bind(this))}},setPageLabels:function(e){if(this.pdfDocument){e?e instanceof Array&&this.pdfDocument.numPages===e.length?this._pageLabels=e:(this._pageLabels=null,console.error("PDFViewer_setPageLabels: Invalid page labels.")):this._pageLabels=null
for(var t=0,i=this._pages.length;i>t;t++){var n=this._pages[t],s=this._pageLabels&&this._pageLabels[t]
n.setPageLabel(s)}}},_resetView:function(){this._pages=[],this._currentPageNumber=1,this._currentScale=d,this._currentScaleValue=null,this._pageLabels=null,this._buffer=new e(B),this._location=null,this._pagesRotation=0,this._pagesRequests=[],this._pageViewsReady=!1,this.viewer.textContent=""},_scrollUpdate:function(){if(0!==this.pagesCount){this.update()
...
for(var r=0,a=this._pages.length;a>r;r++)this._pages[r].update(e)
...
var a,o,h=0,u=0,g=0,v=0,b=r.rotation%180===0?!1:!0,w=(b?r.height:r.width)/r.scale/f,P=(b?r.width:r.height)/r.scale/f,y=0
...
if(0!==t.length){var i=Math.max(B,2*t.length+1)
this._buffer.resize(i),this.renderingQueue.renderHighestPriority(e)
for(var n=this._currentPageNumber,s=e.first,r=0,a=t.length,o=!1;a>r;++r){var h=t[r]
...
return e.push({id:t.id,view:t}),{first:t,last:t,views:e}},cleanup:function(){for(var e=0,t=this._pages.length;t>e;e++)this._pages[e]&&this._pages[e].renderingState!==y.FINISHED&&this._pages[e].reset()},_cancelRendering:function(){for(var e=0,t=this._pages.length;t>e;e++)this._pages[e]&&this._pages[e].cancelRendering()},_ensurePdfPageLoaded:function(e){if(e.pdfPage)return Promise.resolve(e.pdfPage)
var t=e.id
if(this._pagesRequests[t])return this._pagesRequests[t]
var i=this.pdfDocument.getPage(t).then(function(i){return e.setPdfPage(i),this._pagesRequests[t]=null,i}.bind(this))
...
e.PresentationModeState=_,e.PDFViewer=E}),function(e,t){t(e.pdfjsWebApp={},e.pdfjsWebUIUtils,e.pdfjsWebDownloadManager,e.pdfjsWebPDFHistory,e.pdfjsWebPreferences,e.pdfjsWebPDFSidebar,e.pdfjsWebViewHistory,e.pdfjsWebPDFThumbnailViewer,e.pdfjsWebToolbar,e.pdfjsWebSecondaryToolbar,e.pdfjsWebPasswordPrompt,e.pdfjsWebPDFPresentationMode,e.pdfjsWebPDFDocumentProperties,e.pdfjsWebHandTool,e.pdfjsWebPDFViewer,e.pdfjsWebPDFRenderingQueue,e.pdfjsWebPDFLinkService,e.pdfjsWebPDFOutlineViewer,e.pdfjsWebOverlayManager,e.pdfjsWebPDFAttachmentViewer,e.pdfjsWebPDFFindController,e.pdfjsWebPDFFindBar,e.pdfjsWebDOMEvents,e.pdfjsWebPDFJS)}(this,function(e,t,i,n,s,r,a,o,h,d,c,l,u,f,g,p,v,m,b,w,P,y,S,L){function C(e){e.imageResourcesPath="./images/",e.workerSrc="../build/pdf.worker.js",e.cMapUrl="../web/cmaps/",e.cMapPacked=!0}function I(e){return new Promise(function(t,i){var n=ze.appConfig,s=document.createElement("script")
s.src=n.debuggerScriptPath,s.onload=function(){PDFBug.enable(e),PDFBug.init(L,n.mainContainer),t()},s.onerror=function(){i(Error("Cannot load debugger at "+s.src))},(document.getElementsByTagName("head")[0]||document.body).appendChild(s)})}function _(){var e,t=document.location.search.substring(1),i=fe(t)
e="file"in i?i.file:DEFAULT_URL,se(e)
var n=[],s=ze.appConfig,r=document.createElement("input")
...
var a=L.PDFJS
if(ze.viewerPrefs.pdfBugEnabled){var o=document.location.hash.substring(1),h=fe(o)
...
break
case"visible":case"shadow":case"hover":var d=s.viewerContainer
d.classList.add("textLayer-"+h.textlayer)}if("pdfbug"in h){a.pdfBug=!0
var c=h.pdfbug,l=c.split(",")
n.push(I(l))}}ue.setLanguage(a.locale),ze.supportsPrinting||(s.toolbar.print.classList.add("hidden"),s.secondaryToolbar.printButton.classList.add("hidden")),ze.supportsFullscreen||(s.toolbar.presentationModeButton.classList.add("hidden"),s.secondaryToolbar.presentationModeButton.classList.add("hidden")),ze.supportsIntegratedFind&&s.toolbar.viewFind.classList.add("hidden"),s.sidebar.mainContainer.addEventListener("transitionend",function(e){e.target===this&&ze.eventBus.dispatch("resize")},!0),s.sidebar.toggleButton.addEventListener("click",function(){ze.pdfSidebar.toggle()}),Promise.all(n).then(function(){Ge(e)})["catch"](function(e){ze.error(ue.get("loading_error",null,"An error occurred while opening."),e)})}function B(e){var t=e.pageNumber,i=t-1,n=ze.pdfViewer.getPageView(i)
if(t===ze.page&&ze.toolbar.updateLoadingIndicatorState(!1),n){if(ze.pdfSidebar.isThumbnailViewVisible){var s=ze.pdfThumbnailViewer.getThumbnail(i)
s.setImage(n)}L.PDFJS.pdfBug&&Stats.enabled&&n.stats&&Stats.add(t,n.stats),n.error&&ze.error(ue.get("rendering_error",null,"An error occurred while rendering the page."),n.error)}}function E(e){}function T(e){var t,i=e.mode
...
case"none":t=ve.NONE
break
default:return void console.error('Invalid "pagemode" hash parameter: '+i)}ze.pdfSidebar.switchView(t,!0)}function x(e){var t=e.action
switch(t){case"GoToPage":ze.appConfig.toolbar.pageNumber.select()
break
case"Find":ze.supportsIntegratedFind||ze.findBar.toggle()}}function F(e){var t=e.active,i=e.switchInProgress
ze.pdfViewer.presentationModeState=i?_e.CHANGING:t?_e.FULLSCREEN:_e.NORMAL}function D(e){ze.pdfRenderingQueue.isThumbnailViewEnabled=ze.pdfSidebar.isThumbnailViewVisible
var t=ze.store
t&&ze.isInitialViewSet&&t.initializedPromise.then(function(){t.set("sidebarView",e.view)["catch"](function(){})})}function k(e){var t=e.location,i=ze.store
...
var n=ze.pdfLinkService.getAnchorUrl(t.pdfOpenParams)
ze.appConfig.toolbar.viewBookmark.href=n,ze.appConfig.secondaryToolbar.viewBookmarkButton.href=n,ze.pdfHistory.updateCurrentBookmark(t.pdfOpenParams,t.pageNumber)
var s=ze.pdfViewer.getPageView(ze.page-1),r=s.renderingState!==Ee.FINISHED
ze.toolbar.updateLoadingIndicatorState(r)}function V(){var e=ze.pdfViewer.currentScaleValue
"auto"===e||"page-fit"===e||"page-width"===e?ze.pdfViewer.currentScaleValue=e:e||(ze.pdfViewer.currentScaleValue=ae),ze.pdfViewer.update()}function N(e){if(ze.pdfHistory.isHashChangeUnlocked){var t=e.hash
if(!t)return
ze.isInitialViewSet?ze.pdfLinkService.setHash(t):ze.initialBookmark=t}}function M(){ze.requestPresentationMode()}function O(){var e=ze.appConfig.openFileInputName
document.getElementById(e).click()}function R(){window.print()}function A(){ze.download()}function j(){ze.pdfDocument&&(ze.page=1)}function U(){ze.pdfDocument&&(ze.page=ze.pagesCount)}function H(){ze.page++}function W(){ze.page--}function z(){ze.zoomIn()}function q(){ze.zoomOut()}function G(e){var t=ze.pdfViewer
t.currentPageLabel=e.value,e.value!==""+t.currentPageNumber&&e.value!==t.currentPageLabel&&ze.toolbar.setPageNumber(t.currentPageNumber,t.currentPageLabel)}function Q(e){ze.pdfViewer.currentScaleValue=e.value}function J(){ze.rotatePages(90)}function K(){ze.rotatePages(-90)}function X(){ze.pdfDocumentProperties.open()}function Z(e){ze.findController.executeCommand("find"+e.type,{query:e.query,phraseSearch:e.phraseSearch,caseSensitive:e.caseSensitive,highlightAll:e.highlightAll,findPrevious:e.findPrevious})}function Y(e){ze.findController.executeCommand("find",{query:e.query,phraseSearch:e.phraseSearch,caseSensitive:!1,highlightAll:!0,findPrevious:!1})}function $(e){ze.toolbar.setPageScale(e.presetValue,e.scale),ze.pdfViewer.update()}function ee(e){var t=e.pageNumber
if(ze.toolbar.setPageNumber(t,e.pageLabel||null),ze.secondaryToolbar.setPageNumber(t),ze.pdfSidebar.isThumbnailViewVisible&&ze.pdfThumbnailViewer.scrollThumbnailIntoView(t),L.PDFJS.pdfBug&&Stats.enabled){var i=ze.pdfViewer.getPageView(t-1)
i.stats&&Stats.add(t,i.stats)}}function te(e){var t=ze.pdfViewer
if(!t.isInPresentationMode)if(e.ctrlKey||e.metaKey){var i=ze.supportedMouseWheelZoomModifierKeys
if(e.ctrlKey&&!i.ctrlKey||e.metaKey&&!i.metaKey)return
if(e.preventDefault(),Ke)return
var n=t.currentScale,s=Oe(e),r=3,a=s*r
0>a?ze.zoomOut(-a):ze.zoomIn(a)
var o=t.currentScale
if(n!==o){var h=o/n-1,d=t.container.getBoundingClientRect(),c=e.clientX-d.left,l=e.clientY-d.top
t.container.scrollLeft+=c*h,t.container.scrollTop+=l*h}}else Ke=!0,clearTimeout(Je),Je=setTimeout(function(){Ke=!1},1e3)}function ie(e){if(ze.secondaryToolbar.isOpen){var t=ze.appConfig;(ze.pdfViewer.containsElement(e.target)||t.toolbar.container.contains(e.target)&&e.target!==t.secondaryToolbar.toggleButton)&&ze.secondaryToolbar.close()}}function ne(e){if(!De.active){var t=!1,i=!1,n=(e.ctrlKey?1:0)|(e.altKey?2:0)|(e.shiftKey?4:0)|(e.metaKey?8:0),s=ze.pdfViewer,r=s&&s.isInPresentationMode
if(1===n||8===n||5===n||12===n)switch(e.keyCode){case 70:ze.supportsIntegratedFind||(ze.findBar.open(),t=!0)
break
case 71:if(!ze.supportsIntegratedFind){var a=ze.findController.state
a&&ze.findController.executeCommand("findagain",{query:a.query,phraseSearch:a.phraseSearch,caseSensitive:a.caseSensitive,highlightAll:a.highlightAll,findPrevious:5===n||12===n}),t=!0}break
case 61:case 107:case 187:case 171:r||ze.zoomIn(),t=!0
break
case 173:case 109:case 189:r||ze.zoomOut(),t=!0
break
case 48:case 96:r||(setTimeout(function(){s.currentScaleValue=ae}),t=!1)
break
case 38:(r||ze.page>1)&&(ze.page=1,t=!0,i=!0)
break
case 40:(r||ze.page<ze.pagesCount)&&(ze.page=ze.pagesCount,t=!0,i=!0)}if(1===n||8===n)switch(e.keyCode){case 83:ze.download(),t=!0}if(3===n||10===n)switch(e.keyCode){case 80:ze.requestPresentationMode(),t=!0
break
case 71:ze.appConfig.toolbar.pageNumber.select(),t=!0}if(t)return i&&!r&&s.focus(),void e.preventDefault()
...
case 75:case 80:ze.page>1&&ze.page--,t=!0
break
case 27:ze.secondaryToolbar.isOpen&&(ze.secondaryToolbar.close(),t=!0),!ze.supportsIntegratedFind&&ze.findBar.opened&&(ze.findBar.close(),t=!0)
break
case 40:case 34:case 32:if(!r&&"page-fit"!==s.currentScaleValue)break
case 39:if(s.isHorizontalScrollbarEnabled)break
case 74:case 78:ze.page<ze.pagesCount&&ze.page++,t=!0
break
case 36:(r||ze.page>1)&&(ze.page=1,t=!0,i=!0)
break
case 35:(r||ze.page<ze.pagesCount)&&(ze.page=ze.pagesCount,t=!0,i=!0)
break
case 72:r||ze.handTool.toggle()
break
case 82:ze.rotatePages(90)}if(4===n)switch(e.keyCode){case 32:if(!r&&"page-fit"!==s.currentScaleValue)break
ze.page>1&&ze.page--,t=!0
break
case 82:ze.rotatePages(-90)}if(t||r||(e.keyCode>=33&&e.keyCode<=40||32===e.keyCode&&"BUTTON"!==h)&&(i=!0),2===n)switch(e.keyCode){case 37:r&&(ze.pdfHistory.back(),t=!0)
break
case 39:r&&(ze.pdfHistory.forward(),t=!0)}i&&!s.containsElement(o)&&s.focus(),t&&e.preventDefault()}}}var se,re=t.UNKNOWN_SCALE,ae=t.DEFAULT_SCALE_VALUE,oe=t.MIN_SCALE,he=t.MAX_SCALE,de=t.ProgressBar,ce=t.getPDFFileNameFromURL,le=t.noContextMenuHandler,ue=t.mozL10n,fe=t.parseQueryString,ge=n.PDFHistory,pe=s.Preferences,ve=r.SidebarView,me=r.PDFSidebar,be=a.ViewHistory,we=o.PDFThumbnailViewer,Pe=h.Toolbar,ye=d.SecondaryToolbar,Se=c.PasswordPrompt,Le=l.PDFPresentationMode,Ce=u.PDFDocumentProperties,Ie=f.HandTool,_e=g.PresentationModeState,Be=g.PDFViewer,Ee=p.RenderingStates,Te=p.PDFRenderingQueue,xe=v.PDFLinkService,Fe=m.PDFOutlineViewer,De=b.OverlayManager,ke=w.PDFAttachmentViewer,Ve=P.PDFFindController,Ne=y.PDFFindBar,Me=S.getGlobalEventBus,Oe=t.normalizeWheelEventDelta,Re=t.animationStarted,Ae=t.localized,je=t.RendererType,Ue=1.1,He=5e3,We={updateFindControlState:function(e){},initPassiveLoading:function(e){},fallback:function(e,t){},reportTelemetry:function(e){},createDownloadManager:function(){return new i.DownloadManager},supportsIntegratedFind:!1,supportsDocumentFonts:!0,supportsDocumentColors:!0,supportedMouseWheelZoomModifierKeys:{ctrlKey:!0,metaKey:!0}},ze={initialBookmark:document.location.hash.substring(1),initialDestination:null,initialized:!1,fellback:!1,appConfig:null,pdfDocument:null,pdfLoadingTask:null,printService:null,pdfViewer:null,pdfThumbnailViewer:null,pdfRenderingQueue:null,pdfPresentationMode:null,pdfDocumentProperties:null,pdfLinkService:null,pdfHistory:null,pdfSidebar:null,pdfOutlineViewer:null,pdfAttachmentViewer:null,store:null,downloadManager:null,toolbar:null,secondaryToolbar:null,eventBus:null,pageRotation:0,isInitialViewSet:!1,viewerPrefs:{sidebarViewOnLoad:ve.NONE,pdfBugEnabled:!1,showPreviousViewOnLoad:!0,defaultZoomValue:"",disablePageLabels:!1,renderer:"canvas",enhanceTextSelection:!1,renderInteractiveForms:!1},isViewerEmbedded:window.parent!==window,url:"",baseUrl:"",externalServices:We,initialize:function(e){var t=this,i=L.PDFJS
...
do t=(t*Ue).toFixed(2),t=Math.ceil(10*t)/10,t=Math.min(he,t)
while(--e>0&&he>t)
this.pdfViewer.currentScaleValue=t},zoomOut:function(e){var t=this.pdfViewer.currentScale
do t=(t/Ue).toFixed(2),t=Math.floor(10*t)/10,t=Math.max(oe,t)
while(--e>0&&t>oe)
this.pdfViewer.currentScaleValue=t},get pagesCount(){return this.pdfDocument?this.pdfDocument.numPages:0},set page(e){this.pdfViewer.currentPageNumber=e},get page(){return this.pdfViewer.currentPageNumber},get printing(){return!!this.printService},get supportsPrinting(){return Xe.instance.supportsPrinting},get supportsFullscreen(){var e,t=document.documentElement
return e=!!(t.requestFullscreen||t.mozRequestFullScreen||t.webkitRequestFullScreen||t.msRequestFullscreen),(document.fullscreenEnabled===!1||document.mozFullScreenEnabled===!1||document.webkitFullscreenEnabled===!1||document.msFullscreenEnabled===!1)&&(e=!1),e&&L.PDFJS.disableFullscreen===!0&&(e=!1),L.shadow(this,"supportsFullscreen",e)},get supportsIntegratedFind(){return this.externalServices.supportsIntegratedFind},get supportsDocumentFonts(){return this.externalServices.supportsDocumentFonts},get supportsDocumentColors(){return this.externalServices.supportsDocumentColors},get loadingBar(){var e=new de("#loadingBar",{})
return L.shadow(this,"loadingBar",e)},get supportedMouseWheelZoomModifierKeys(){return this.externalServices.supportedMouseWheelZoomModifierKeys},initPassiveLoading:function(){throw Error("Not implemented: initPassiveLoading")},setTitleUsingUrl:function(e){this.url=e,this.baseUrl=e.split("#")[0]
try{this.setTitle(decodeURIComponent(L.getFilenameFromUrl(e))||e)}catch(t){this.setTitle(e)}},setTitle:function(e){this.isViewerEmbedded||(document.title=e)},close:function(){var e=this.appConfig.errorWrapper.container
...
var n={message:t}
throw r.error(i,n),Error(i)})},download:function(){function e(){n.downloadUrl(t,i)}var t=this.baseUrl,i=ce(t),n=this.downloadManager
return n.onerror=function(e){ze.error("PDF failed to download.")},this.pdfDocument&&this.downloadComplete?void this.pdfDocument.getData().then(function(e){var s=L.createBlob(e,"application/pdf")
...
r.textContent=e
var a=n.closeButton
a.onclick=function(){s.setAttribute("hidden","true")}
var o=n.errorMoreInfo,h=n.moreInfoButton,d=n.lessInfoButton
h.onclick=function(){o.removeAttribute("hidden"),h.setAttribute("hidden","true"),d.removeAttribute("hidden"),o.style.height=o.scrollHeight+"px"},d.onclick=function(){o.setAttribute("hidden","true"),h.removeAttribute("hidden"),d.setAttribute("hidden","true")},h.oncontextmenu=le,d.oncontextmenu=le,a.oncontextmenu=le,h.removeAttribute("hidden"),d.setAttribute("hidden","true"),o.value=i},progress:function(e){var t=Math.round(100*e);(t>this.loadingBar.percent||isNaN(t))&&(this.loadingBar.percent=t,L.PDFJS.disableAutoFetch&&t&&(this.disableAutoFetchLoadingBarTimeout&&(clearTimeout(this.disableAutoFetchLoadingBarTimeout),this.disableAutoFetchLoadingBarTimeout=null),this.loadingBar.show(),this.disableAutoFetchLoadingBarTimeout=setTimeout(function(){this.loadingBar.hide(),this.disableAutoFetchLoadingBarTimeout=null}.bind(this),He)))},load:function(e,t){var i=this
...
if(i.viewerPrefs.showPreviousViewOnLoad&&a.get("exists",!1)){var r=a.get("page","1"),o=i.viewerPrefs.defaultZoomValue||a.get("zoom",ae),h=a.get("scrollLeft","0"),d=a.get("scrollTop","0")
e="page="+r+"&zoom="+o+","+h+","+d,n=a.get("sidebarView",ve.NONE)}else i.viewerPrefs.defaultZoomValue&&(e="page=1&zoom="+i.viewerPrefs.defaultZoomValue)
...
if(r&&t.test(r))return void setTimeout(function(){window.print()})}})}),Promise.all([c,Re]).then(function(){e.getOutline().then(function(e){i.pdfOutlineViewer.render({outline:e})}),e.getAttachments().then(function(e){i.pdfAttachmentViewer.render({attachments:e})})}),e.getMetadata().then(function(e){var t=e.info,n=e.metadata
i.documentInfo=t,i.metadata=n
var s
if(n&&n.has("dc:title")){var r=n.get("dc:title")
"Untitled"!==r&&(s=r)}!s&&t&&t.Title&&(s=t.Title),s&&i.setTitle(s+" - "+document.title),t.IsAcroFormPresent&&(console.warn("Warning: AcroForm/XFA is not supported"),i.fallback(L.UNSUPPORTED_FEATURES.forms))})},setInitialView:function(e,t){var i=t&&t.scale,n=t&&t.sidebarView
...
return void window.alert(t)}var i=this.pdfViewer.getPagesOverview(),n=this.appConfig.printContainer,s=Xe.instance.createPrintService(this.pdfDocument,i,n)
this.printService=s,this.forceRendering(),s.layout()}},get hasEqualPageSizes(){for(var e=this.pdfViewer.getPageView(0),t=1,i=this.pagesCount;i>t;++t){var n=this.pdfViewer.getPageView(t)
...
i&&0!==i.length&&e.dispatch("fileinputchange",{fileInput:t.target})})}},qe=["null","http://mozilla.github.io","https://mozilla.github.io"]
se=function(e){try{var t=new URL(window.location.href).origin||"null"
if(qe.indexOf(t)>=0)return
var i=new URL(e,window.location.href).origin
if(i!==t)throw Error("file origin does not match viewer's")}catch(n){var s=n&&n.message,r=ue.get("loading_error",null,"An error occurred while loading the PDF."),a={message:s}
throw ze.error(r,a),n}}
var Ge
Ge=function(e){if(e&&0===e.lastIndexOf("file:",0)){ze.setTitleUsingUrl(e)
var t=new XMLHttpRequest
t.onload=function(){ze.open(new Uint8Array(t.response))}
try{t.open("GET",e),t.responseType="arraybuffer",t.send()}catch(i){ze.error(ue.get("loading_error",null,"An error occurred while loading the PDF."),i)}}else e&&ze.open(e)}
var Qe
Qe=function(e){var t=e.fileInput.files[0]
if(!L.PDFJS.disableCreateObjectURL&&"undefined"!=typeof URL&&URL.createObjectURL)ze.open(URL.createObjectURL(t))
else{var i=new FileReader
i.onload=function(e){var t=e.target.result,i=new Uint8Array(t)
ze.open(i)},i.readAsArrayBuffer(t)}ze.setTitleUsingUrl(t.name)
var n=ze.appConfig
...
var Xe={instance:{supportsPrinting:!1,createPrintService:function(){throw Error("Not implemented: createPrintService")}}}
e.PDFViewerApplication=ze,e.DefaultExernalServices=We,e.PDFPrintServiceFactory=Xe}),function(e,t){t(e.pdfjsWebPDFPrintService={},e.pdfjsWebUIUtils,e.pdfjsWebOverlayManager,e.pdfjsWebApp,e.pdfjsWebPDFJS)}(this,function(e,t,i,n,s){function r(e,t,i,n){var s=p.scratchCanvas,r=150,a=r/72
s.width=Math.floor(n.width*a),s.height=Math.floor(n.height*a)
var o=Math.floor(n.width*u)+"px",h=Math.floor(n.height*u)+"px",d=s.getContext("2d")
return d.save(),d.fillStyle="rgb(255, 255, 255)",d.fillRect(0,0,s.width,s.height),d.restore(),t.getPage(i).then(function(e){var t={canvasContext:d,transform:[a,0,0,a,0,0],viewport:e.getViewport(1),intent:"print"}
return e.render(t).promise}).then(function(){return{width:o,height:h}})}function a(e,t,i){this.pdfDocument=e,this.pagesOverview=t,this.printContainer=i,this.currentPage=-1,this.scratchCanvas=document.createElement("canvas")}function o(e){var t=document.createEvent("CustomEvent")
...
var t=this.pagesOverview.every(function(e){return e.width===this.pagesOverview[0].width&&e.height===this.pagesOverview[0].height},this)
...
return e.preventDefault(),void(e.stopImmediatePropagation?e.stopImmediatePropagation():e.stopPropagation())}},!0),m&&document.attachEvent("onkeydown",function(e){return e=e||window.event,80===e.keyCode&&e.ctrlKey?(e.keyCode=0,!1):void 0}),"onbeforeprint"in window){var b=function(e){"custom"!==e.detail&&e.stopImmediatePropagation&&e.stopImmediatePropagation()}
window.addEventListener("beforeprint",b),window.addEventListener("afterprint",b)}var w
f.instance={supportsPrinting:!0,createPrintService:function(e,t,i){if(p)throw Error("The print service is created and active.")
return p=new a(e,t,i)}},e.PDFPrintService=a})}.call(pdfjsWebLibs),"interactive"===document.readyState||"complete"===document.readyState?webViewerLoad():document.addEventListener("DOMContentLoaded",webViewerLoad,!0)
