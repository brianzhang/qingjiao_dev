...
<body style="height: 100%; width: 100%; margin: 10px; padding: 10px; font-size:13px">
	...
	<div style='clear:both'><br><input style='width:48px;height:25;border:0px;background-image:url("<%=request.getContextPath()%>/dm/images/btn_bg.png")' type=button value=保存 onclick="resetParam();"></div>
</body>
</html>
