...
<div style='height:30px;padding: 6px 0 3px 408px;background-color:#CEE2F9;'>
	<input type='button' onmouseover='this.style.cursor="hand"' style='background-image:url("<%=cp%>/dm/images/but_back_2.png");border:0px;width:51;height:22px;' onclick="saveChart();" value='保存'>
