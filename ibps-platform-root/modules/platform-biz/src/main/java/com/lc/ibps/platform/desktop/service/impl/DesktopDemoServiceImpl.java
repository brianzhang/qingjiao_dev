...
import com.lc.ibps.platform.desktop.service.DesktopDemoService;
 ...
 * 日期：2015年11月22日-下午11:25:06
 * 版权：广州流辰信息技术有限公司版权所有
 * </pre>
 */
@Service("desktopDemoService")
public class DesktopDemoServiceImpl implements DesktopDemoService {
	@Override
	public String myCalendar() {
		...
		for (int i = 0; i < 100; i++) {
			...
			json.accumulate("title", "所有事件")
					...
					.accumulate("backgroundColor", "#F8CB00")
		...
		// {title: '所有事件',start: new Date(y, m, 1),backgroundColor:
		// Theme.colors.blue
		json3.accumulate("title", "链接到公司网站")
				.accumulate("start",
						DateFormatUtil.format(ca.getTime(), "yyyy-MM-dd"))
				.accumulate("url", "http://t.cn/REYNcgu")
				.accumulate("backgroundColor", "#9b59b6");
		jsonAry.add(json3);
	...
	public String pieChart() {
		int  nonstop = (int) (Math.random() * 1000) ;
		int  edm = nonstop-15 ;
		int  adsense = nonstop-50 ;
		int  videoAds =nonstop-120 ;
		int  baidu = nonstop+300;
		int  google =baidu-120;
		int  bing = baidu-200;
		int  other = baidu-230;
		
		int mad =edm+adsense+videoAds;
		int se = baidu+google+bing+other;
			    ...
			    + " legend: {"
				    ...
				    + "series: ["
				        + "{"
				            ...
				            + "labelLine: {"
				                + "normal: {"
				                    ...
				                    + " },"
				            + "data:["
				               + " {value:"+nonstop+", name:'直达', selected:true},"
				                + "{value:"+mad+", name:'营销广告'},"
				               + " {value:"+se+", name:'搜索引擎'}"
				           + " ]"
				           + " },"
				        + "{"
				            ...
				            + "data:["
				               + " {value:"+nonstop+", name:'直达'},"
				               + " {value:"+edm+", name:'邮件营销'},"
				                + "{value:"+adsense+", name:'联盟广告'},"
				                + "{value:"+videoAds+", name:'视频广告'},"
				                + "{value:"+baidu+", name:'百度'},"
