  <#-- LayerSlider start -->
  <div class="portlet-layerslider" style="width: 100%; height: ${model.height}px; margin: 0 auto;">

<#-- slide one start -->
<div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 24,25,27,28;">

  <img src="${ctx}/styles/commons/images/slide1/bg.png" class="ls-bg" alt="Slide background">
  ...
  <div class="ls-l ls-title" style="top: 96px; left: 35%; white-space: nowrap;" data-ls="
    ...
    scaleout: .5; 
    showuntil: 4000;
  ">ibps<strong>开源、轻量级的</strong> 企业流程业务开发平台</div>
...
<div class="ls-slide ls-slide2" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
  ...
  <img src="${ctx}/styles/commons/images/slide2/bg.png" class="ls-bg" alt="Slide background">
  ...
  scaleout: .5; 
  showuntil: 4000;
  "> <strong>ibps办公自动化平台</strong> 
    </div>

  <div class="ls-l" style="top: 50%; left: 45%; white-space: nowrap;" data-ls="
  fade: true; 
  fadeout: true;  
  durationout: 109750; 
  easingin: easeOutQuint; 
  ...
  scalein: .8; 
  scaleout: .8; 
  showuntil: 4000;"><strong><span>基于JBPM4的流程引擎，满足你的日常办公需求</span></strong>
  </div>
...
<div class="ls-slide ls-slide3" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 92,93,105;">
  ...
  <img src="${ctx}/styles/commons/images/slide3/bg.png" class="ls-bg" alt="Slide background">
  ...
  scaleout: .5; 
  showuntil: 4000;
  ">ibps<strong>开源、轻量级的</strong> 企业流程业务开发平台
  </div>
...
<div class="ls-slide ls-slide4" data-ls="offsetxin: right; slidedelay: 7000; transition2d: 110,111,112,113;">
  ...
  <img src="${ctx}/styles/commons/images/slide5/bg.png" class="ls-bg" alt="Slide background">
  ...
  scaleout: .5; 
  showuntil: 4000;">
 ibps<br><strong>开源、轻量级的</strong><br> 企业流程业务开发平台
  </div>
  ...
  showuntil: 4000;">
  <span>咨询电话：</span>
  <a href="javascript:;">400-885-0207</a>
  </div>
