	...
	<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
		...
		<div class="panel-toolbar ">
			<div class="buttons">
             ...
             <a id="view2"class="btn btn-primary fa fa-edit "  href="${ctx}/bishe/oldFile/oldFile/list.htm?id=${urlZhiYuan.id}&type=1"><span >查看历史审批文件</span></a> 
			</div>
		</div>
		<div class="">
		<h2 id="x">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp指导教师审阅开题报告</h2>
		<h2 id="y">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp基层负责人审阅开题报告</h2>
		</br>
			...
			<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">综合意见</label>
				  	<div class="fr-form-block">
				<textarea style="font-size:15px; width:800px; height:200px" class="fr-form-control fr-control-textarea"  name="m:urlZhiYuan:td3"  validate="{required:false}">${urlZhiYuan.td3}</textarea>
				 	</div>
			  	</div>
			</div>
