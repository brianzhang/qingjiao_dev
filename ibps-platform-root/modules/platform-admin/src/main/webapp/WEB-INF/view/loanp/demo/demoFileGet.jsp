...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="demoFileForm" >
				 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">文件名</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${demoFile.name}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">所属贷款</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${demoFile.loanid}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">文件串</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${demoFile.file}</p>
				 	</div>
			  	</div>
			</div>
	</form>
