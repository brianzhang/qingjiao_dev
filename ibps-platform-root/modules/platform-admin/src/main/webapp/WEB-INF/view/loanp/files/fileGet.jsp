...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="fileForm" >
			...
			<p class="form-control-static">${file.name}</p>
			 	...
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">文件地址</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${file.filePath}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">借贷id</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${file.jdid}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">viewer</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${file.viewer}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">uploader</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${file.uploader}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">上传日期</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${file.time}</p>
				 	</div>
			  	</div>
			</div>
	</form>
