...
<script type="text/javascript" src="${ctx}/js/lc/platform/form/formPrintTemplateListDialog.js"></script>

<script type="text/javascript" src="${ctx}/js/plugins/laypage/laypage.js"></script>
<script type="text/javascript" src="${ctx}/js/lc/platform/form/formDefList.js"></script>
<title>设计表单管理列表</title>
</head>
<body>

<div class="dashboard">
		<div class="dashboard-header">
              <h2 class="pull-left">自定义表单</h2>
                          <div id="formPage" class="pull-right"></div>
              <form class="form-inline form-search" >
                  <div class="input-group ">
                      <input type="text" class="form-control"  name="Q^NAME_^SL" placeholder="表单名称"/>
				...
				<div class="input-group">
					<a href="javascript:void(0);" class="btn btn-info btn-mx fa fa-import" id="import"><span>导入</span></a>
				</div>
				<div class="input-group">
					<a href="javascript:void(0);" class="btn btn-info btn-mx fa fa-export" id="export"><span>导出</span></a>
				</div>
              </form>
	       			...
	       			<a href="javascript:void(0)">
						...
						<div class="symbol">
					        <i class="symbol-color form-color-3">
					          <i class="symbol-icon fa {{if item.mode == 'bo'}}fa-table{{else if item.mode == 'codeGen'}}fa-list-alt{{else}}fa-list{{/if}}"></i>
					        </i>
						</div>
						<div class="form-data" >
...
<ul class="dashboard-settings-options dropdown-menu" data-id="{{id}}"  data-key={{key}}>
    ...
    <li class="delete-form">
 	...
 	<li class="copy-form" >
      <a href="javascript:void(0)">
 	 	<i class="item-icon fa fa-copy"></i>
 	 	<span>复制</span>
	  </a>
	</li>
    <li  role="separator" class="divider"></li>
	<li class="form-rights" >
      <a href="javascript:void(0)">
 	 	<i class="item-icon fa fa-cog"></i>
 	 	<span>表单权限</span>
	  </a>
	</li>
	<li class="print-template" >
      <a href="javascript:void(0)">
 	 	<i class="item-icon fa fa-print"></i>
 	 	<span>打印模版</span>
	  </a>
	</li>
  </ul>
