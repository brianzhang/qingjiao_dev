				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/repairp/HCPeiZhi/haoCaiPeiZhi/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/repairp/HCPeiZhi/haoCaiPeiZhi/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/repairp/HCPeiZhi/haoCaiPeiZhi/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
...
<!-- 								<div class="form-group">
	...
	<!-- 							<div class="form-group">
			...
			<div class="jqGrid_wrapper">
				<table id="haoCaiPeiZhiGrid" ></table>
				<div id="haoCaiPeiZhiPager"></div>
			</div>
		</div>
