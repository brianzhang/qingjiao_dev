...
<%--  			 <div class="fr_response_field col-sm-12" >
				...
				<div class="input-icon" >
					...
					<div class="fr_response_field col-sm-12" id="time">
			 	<div class="fr-form-group">
				...
				<input type="text" class="fr-form-control"  name="m:gradGroup:time" value="${gradGroup.time}" validate="{required:false}" />
  			 	...
  			 	<div class="fr_response_field col-sm-12" id="place">
			 	<div class="fr-form-group"> 
...
<%-- 			<div class="fr_response_field col-sm-12" >
			...
			<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">类型</label>
				  	<div class="fr-form-block">
				<select class="fr-form-control" id="type" name="m:gradGroup:type"   validate="{required:false}" onchange="view()">
					<option value="-1"></option>	
					<c:forEach items="${typeList}" var="type">
						<option value="${type}" <c:if test="${type == curtype }">selected</c:if>>${type}</option>
					</c:forEach>
...
<script type="text/javascript">
	...
	$(function(){
		...
		if(type=="答辩"){ //该论文未上传
			document.getElementById("time").style.display = "inline";
            document.getElementById("palce").style.display = "inline";
		}else{
            document.getElementById("time").style.display = "none";
            document.getElementById("place").style.display = "none";
		}
