...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="dingWeiFormGet" >
				 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">创建时间</label>
				  	<div class="fr-form-block">
							<p class="form-control-static"><fmt:formatDate value="${dingWei.createTime}" /></p>		
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			...
			${dingWei.sheHuiXuQiu}
			 	...
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">方案ID</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${dingWei.fangAnID}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">方案名称</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${dingWei.fangMingCheng}</p>
				 	</div>
			  	</div>
			</div>
	</form>
