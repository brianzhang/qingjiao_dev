      ...
      <ul class="nav pull-right" id="menu-layoutit">
        <li>
          <div class="btn-group" data-toggle="buttons-radio">	
            <button class="btn  btn-xs btn-primary" id="button-my-save-modal"  role="button" data-target="#saveMyModal"><i class="glyphicon-floppy-disk glyphicon"></i> 保存</button>
<!--             <button class="btn  btn-xs btn-primary"   type="button" id="button-download-modal" data-target="#downloadModal" role="button" data-toggle="modal"><i class="glyphicon glyphicon-console"></i> 源码</button>
 -->       <button class="btn  btn-xs btn-primary" href="#clear" id="clear" ><i class="glyphicon-trash glyphicon"></i> 清空</button>
		  ...
		  <div class="btn-group" data-toggle="buttons-radio">
		    <c:if test="${desktopMyLayout.id != null }">
		          <button class="btn  btn-xs btn-primary"   type="button" id="button-delete-modal" data-target="#delete" role="button" var="${desktopMyLayout.id}" ><i class="glyphicon glyphicon-remove"></i>删除设计模版</button>
            </c:if>
		  	<button class="btn  btn-xs btn-primary" href="#template" id="template"><i class="glyphicon glyphicon-zoom-in"></i>选择模版</button>
		  </div>
	...
	<!--/row-->
  	...
  	<textarea id= "html" rows="0" cols="0" style="display: none;">${fn:escapeXml(desktopMyLayout.designHtml )}</textarea>
