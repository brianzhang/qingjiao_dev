...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="tptFormGet" >
				 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">tptName</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${tpt.tptName}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">tptLb</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${tpt.tptLb}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">json</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${tpt.json}</p>
				 	</div>
			  	</div>
			</div>
	</form>
