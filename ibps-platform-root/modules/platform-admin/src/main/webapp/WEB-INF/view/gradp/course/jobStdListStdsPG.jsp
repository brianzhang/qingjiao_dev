			...
			<div class="toolbar-box">
				<div class="toolbar-head clearfix">
					...
					<div class="buttons">
						...
						<a class="btn btn-primary fa  fa-pencil  " id="submitScore" href="${ctx }/gradp/course/crsJob/list.htm?crsTchId=${crsTchId}&crsName=${crsName }"><span>批量修改成绩</span></a>
						<a class="btn btn-primary fa  fa-pencil  " id="submitScore" href="${ctx }/gradp/course/crsJob/lpromptSY.htm?crsTchId=${crsTchId}&crsName=${crsName }"><span>发送未提交通知</span></a>
						<a class="btn btn-primary fa  fa-pencil  " id="submitScore" href="${ctx }/gradp/course/crsJob/promptTJhtm?crsTchId=${crsTchId}&crsName=${crsName }"><span>发送未审阅通知</span></a>
					</div>
					&nbsp;
...
<script type="text/javascript" src="${ctx}/js/lc/gradp/course/jobStdListStdPG.js"></script>
</html>
