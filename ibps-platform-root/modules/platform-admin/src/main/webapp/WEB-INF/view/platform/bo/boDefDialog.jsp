...
<script type="text/javascript" src="${ctx}/js/lc/platform/bo/boDefSelector.js"></script>
</head>
<body>
	<div class="wrapper wrapper-content col-sm-12">
		<div class="selector-wrapper">
			<div  class ="selector-container" name="bo_container" >
			</div>
		</div>
		<div class="row">
							...
							<div class="toolbar-body">
								<form role="form" class="search-form">
									<div class="form-inline p-xxs">
										...
										<div class="form-group">
											<label class="search-label">编码</label>: <input type="text"
												name="Q^CODE_^SL" class="form-control" />
										</div>
									</div>
								</form>
							</div>
