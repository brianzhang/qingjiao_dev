...
<!-- 									<div class="form-group">
								...
								<div  class="form-inline p-xxs">
									<div class="form-group">
										<label   class="search-label">审批时间 从</label>:
											<input type="text"  name="Q^ec.end_time_^DL"  class="form-control date"  />
										
									</div>
										<div class="form-group">
										<label   class="search-label">至</label>:
										<input type="text"  name="Q^ec.end_time_^DG"  class="form-control date"  />
									</div>
								</div>
						</form>
					</div><!--/ 查询条件-->
