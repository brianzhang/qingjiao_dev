						...
						<form role="form" class="search-form" action="${ctx}/platform/report/raqsoft/showReport.htm">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label class="search-label">流程类别</label>:
									<select name="type" class="form-control search-select">
										<option value=""></option>
										<c:forEach items="${types }" var="type">
											<option value="${type.typeKey }">${type.name }</option>
										</c:forEach>
									</select>
								</div>
<!-- 								<div class="form-group"> -->
...
<!-- 								</div> -->
			...
			<div class="report_wrapper">
				<iframe id="raqsoftFrame" src="${ctx }/platform/report/raqsoft/showReport.htm?reportName=${reportName}" style="width:100%;border: 0px;"></iframe>
			</div>
			<!-- #分页条件-->
