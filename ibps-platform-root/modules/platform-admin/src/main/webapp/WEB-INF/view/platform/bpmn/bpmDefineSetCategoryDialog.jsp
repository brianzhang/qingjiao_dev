...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmDefineSetCategoryDialog.js"></script>
	</head>
	<body>
			...
			<form id="frmDel">
				<div class="form-group col-sm-12">
					...
					<div class="col-sm-10">
                        ...
                        <input type="text" class="form-control comboTree"  id="flowType" name="flowType" 
                                  data-toggle="comboTree"  data-type="FLOW_TYPE" data-id="#typeId"  readonly
                                  value="${flowType}"  validate="{required:true}"/>
					</div>
				</div>
