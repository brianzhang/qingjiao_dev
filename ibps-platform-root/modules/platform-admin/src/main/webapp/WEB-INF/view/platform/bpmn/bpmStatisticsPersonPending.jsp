...
<html>
	<head>
		...
		<title>待办事务最多人员排名表</title>
		<script type="text/javascript">
			var printPosition ='bottom';
			var orgList = ${orgList};
		</script>
		<script type="text/javascript" src="${ctx}/js/plugins/artTemplate/artTemplate.js"></script>
		<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmStatisticsPersonPending.js"></script>
	</head>
	<body>
		<div id="report_preview" class="wrapper wrapper-content  animated fadeInRight col-sm-12">
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form" action="${ctx}/platform/report/raqsoft/showReport.htm">
							<div  class="form-inline p-xxs">
								<input type="hidden" name="reportName" value="demo_statistics_person_pending" />
								<div class="form-group">
									<label class="search-label">部门</label>:
									<select name="orgId" id="departId" class="form-control search-select">
										<option value="" selected></option>
										<option value="$null">其他</option>
									</select>
								</div>
								<div class="form-group">
									<label class="search-label">显示数量</label>:
									<select name="limit" class="form-control search-select">
										<option value="" selected></option>
								...
								<div class="form-group">
									<label class="search-label">数值限制</label>:
			...
			<div class="report_wrapper">
				<iframe id="raqsoftFrame" src="${ctx }/platform/report/raqsoft/showReport.htm?reportName=demo_statistics_person_pending" style="width:100%;border: 0px;"></iframe>
			</div>
			<!-- #分页条件-->
