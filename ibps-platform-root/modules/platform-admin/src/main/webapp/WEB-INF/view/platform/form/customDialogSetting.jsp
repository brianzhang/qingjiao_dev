...
<script type="text/javascript" src="${ctx}/js/lc/platform/form/customDialogSetting.js"></script>
</head>
<body id="customDialogSetting">
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse"
							data-parent="#accordion1" href="#collapse1"> <i
							class="fa fa-angle-down bigger-110"
							data-icon-hide="fa fa-angle-down"
							data-icon-show="fa fa-angle-right"></i> &nbsp; 显示字段
						</a>
					</h4>
				</div>
				<%--显示字段面板  --%>
				<c:choose>
					<c:when test="${style==0 }">
						<div class="panel-collapse collapse" id="collapse1">
							<div class="panel-body  fieldContainer displayContainer">
								<div class="content">
									<table cellpadding="1"
										class="table table-bordered  table-striped" cellspacing="1">
										<tr>
											<th width="10%">字段名</th>
											<th width="10%">显示名</th>
											<th width="10%">显示类型</th>
					...
					<c:otherwise>
						<div class="panel-collapse collapse" id="collapse1">
							<div class="panel-body  treeContainer">
								<div class="content">
									<table class="table" cellpadding="0" cellspacing="0" border="0">
										<tr>
											<th width="20%">ID:</th>
											<td><input type="text" id="treeId" name="treeId"
												class="inputText treeField"
												value="${ customDialog.treeField.id}" /></td>
										</tr>
										<tr>
											<th width="20%">父ID:</th>
											<td><input type="text" id="parentId" name="parentId"
												class="inputText treeField"
												value="${ customDialog.treeField.pid}" /></td>
										</tr>
										<tr>
											<th width="20%">父ID初始值:</th>
											<td><textarea id="parentValue" name="parentValue"
													class="inputText treeField" cols="40" rows="5"></textarea>
												<input type="checkbox" name="isScript" id="isScript" />脚本</td>
										</tr>
										<tr>
											<th width="20%">显示名称:</th>
											<td><input type="text" id="displayName"
												name="displayName" class="inputText treeField"
												value="${customDialog.treeField.displayName}" /></td>
										</tr>
									</table>
								</div>
							</div>
							...
							<div id="enum">
															<div class="margin-10">
																...
																<span
																		...
																		onclick="customDialogSetting._addSelect(this)"
																		style="position: absolute; right: 23%;">
																	</span>
															</div>
															{{each enumStr as param}}
															<div class="margin-10">
	...
	<script type="text/html" id='sortFieldTem'>
				<tr id="sort{{fieldName}}" name="{{fieldName}}">
						<td>{{fieldName}}</td>
						<td>
								<label><input type="checkbox" name="direction"   {{if direction=='ASC'}}   checked="true"	{{/if}}/>&nbsp;升序（不勾选则为降序）</label>
						</td>
						<td>
							<a href='#' class='btn btn-info  fa fa-arrow-up' id='trUp' title='上移'></a>&nbsp;
							<a href='#' class='btn btn-info  fa fa-arrow-down' id='trDown' title='下移'></a>&nbsp;
