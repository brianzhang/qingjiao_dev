		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="panel-body">
				<div class="wrapper wrapper-content col-sm-12">
					<div class="row">
						<div class="panel-form col-sm-4 panel-left">
							<div style="height: 28px; margin-top: 2px">
								<a class="btn btn-sm btn-primary fa fa-delete" href="#"
									onclick="delPic();"><span>删除图片</span></a> <a
									class="btn btn-sm btn-primary fa fa-cloud-upload" href="#"
									onclick="addPic();"><span>上传图片</span></a>
							</div>
							<div>
								<p>
									<c:if test="${not empty news && not empty news.picture}">
										<img id="newsPic" style="height: 400px; width: 380px"
											src="${ctx}/${news.picture}" 
											alt="图片" />
									</c:if>
									<c:if test="${empty news || empty news.picture}">
										<img id="newsPic" style="height: 400px; width: 380px"
											src="${ctx}/styles/default/images/webupload/image.png"/>
									</c:if>
								</p>
							</div>
						</div>
