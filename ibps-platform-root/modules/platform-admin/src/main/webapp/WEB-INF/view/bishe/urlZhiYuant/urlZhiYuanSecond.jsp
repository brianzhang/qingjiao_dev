		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="fr_response_field col-sm-12" >
				...
				<input type="text" class="fr-form-control" name="m:urlZhiYuan:name" value="${urlZhiYuan.name}" disabled="true" validate="{required:false"/>
			 	...
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">学生所选团队2</label>
				  	<div class="fr-form-block">
				   <input type="text"   class="fr-form-control"  name="m:urlZhiYuan:td2"  disabled="true"  validate="{required:false}" value="${urlZhiYuan.td2}"/>
				 </div>
				 	</div>
			  	</div>
               ...
               <br/>
					<div class="">
				          <iframe id="iframe1"  name="iframe1"  width="100%" height="600px" frameborder=no  border=0  marginwidth=0  marginheight=0  scrolling=no src="${ctx}/bishe/teacherAndStudent/teacherAndStudent/list.htm?id=${urlZhiYuan.td2id}"></iframe>			
	        </div
