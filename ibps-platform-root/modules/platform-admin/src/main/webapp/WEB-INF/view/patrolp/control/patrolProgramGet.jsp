...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="patrolProgramFormGet" >
				 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">名称</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${.mingChen}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">执行人</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${.zhiHengRen}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">需巡列表</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${.xuXunLieBiao}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">巡课时间</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${.xunKeShiJian}</p>
				 	</div>
			  	</div>
			</div>
	</form>
