		...
		<div class="toolbar-panel ">
			<div class="toolbar-box">
				<div class="toolbar-head clearfix">
					...
					<!-- 收缩 -->
					<div class="tools">
						<h2 style="float:left;line-height:1.7em">${crsName }&nbsp;作业列表&nbsp;</h2>
...
<script type="text/javascript">
	var normalteacher = ${normalteacher};
	var shenyue = ${shenyue};
...
<script type="text/javascript" src="${ctx}/js/lc/gradp/course/crsJob2.js"></script>
