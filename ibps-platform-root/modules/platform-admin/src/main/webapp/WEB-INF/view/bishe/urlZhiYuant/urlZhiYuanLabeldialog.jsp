...
<script type="text/javascript" src="${ctx}/js/lc/bishe/urlZhiYuant/labelSelector.js"></script>
</head>
<body>
							...
							<div class="toolbar-head clearfix">
								...
								<div class="buttons">
									<a class="btn btn-primary fa fa-search"
										href="javascript:void(0);"><span>标签搜索</span></a>
								</div>
								<!-- 收缩 -->
								<div class="tools">
								...
								<form role="form" class="search-form">
									<div class="form-inline p-xxs">
										<div class="form-group">
											<label class="search-label">标签名</label>: <input type="text"
												id="fullname" name="Q^LABEL_NAME_^SL" class="form-control" />
										</div>
								<div class="form-group">
