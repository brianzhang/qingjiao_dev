	...
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/platform/codegen/purchaseAttach/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/platform/codegen/purchaseAttach/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/platform/codegen/purchaseAttach/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label   class="search-label">文档名称</label>:
									<input type="text"  name="Q^DOCUMENT_NAME_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">选择附件</label>:
									<input type="text"  name="Q^SELECT_ATTACHMENT_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
			...
			<div class="jqGrid_wrapper">
				<table id="purchaseAttachGrid" ></table>
				<div id="purchaseAttachPager"></div>
			</div>
		</div>
