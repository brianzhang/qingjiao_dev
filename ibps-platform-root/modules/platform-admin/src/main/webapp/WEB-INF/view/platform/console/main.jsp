	...
	<div id="navbar" class="navbar navbar-default navbar-collapse  h-navbar" >
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left"  id="navbar-header">
				...
				<!-- #section:basics/navbar.layout.brand -->
					<a data-toggle="dropdown" class="navbar-brand dropdown-toggle dropdown-menu-center  dropdown-hover dropdown-caret">
						...
						<c:if test="${(subsystemList)!= null && fn:length(subsystemList) > 1}">
			...
			<!-- 				<li>
							...
							<c:if test="${showVer!=null}">
							<li>
								<a href="javascript:void(0);" onclick="mainPlugin.showVerInfo()">
									<i class="ibps-icon fa fa-exclamation-circle"></i>
									版本信息
								</a>
							</li>
							</c:if>
