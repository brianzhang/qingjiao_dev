...
<html>
	<head>
		...
		<title>节点操作效率人员耗时统计表</title>
		<script type="text/javascript">
			var printPosition ='${ printPosition }';
		</script>
		<script type="text/javascript" src="${ctx}/js/plugins/artTemplate/artTemplate.js"></script>
		<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmStatisticsApproveEfficiency.js"></script>
	</head>
	<body>
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form" action="${ctx}/platform/report/raqsoft/showReport.htm">
							<div  class="form-inline p-xxs">
								<input type="hidden" name="reportName" value="demo_statistics_approve_efficiency" />
...
<!-- 								</div> -->
			...
			<div class="report_wrapper">
				<iframe id="raqsoftFrame" src="${ctx }/platform/report/raqsoft/showReport.htm?reportName=demo_statistics_approve_efficiency" style="width:100%;border: 0px;"></iframe>
			</div>
			<!-- #分页条件-->
