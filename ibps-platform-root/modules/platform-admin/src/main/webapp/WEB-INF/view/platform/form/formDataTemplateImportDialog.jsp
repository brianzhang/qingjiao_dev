...
<body>
	<form id="importForm" action="importTemplate.htm" method="post" enctype="multipart/form-data">
		<table class="table-form" cellspacing="0">
			<tr>
				<th><span>选择文件:</span></th>
				<td>
					<input type="file" size="100" name="file" id="file"  class="inputText input-wh-9" validate="{required:true}"/>
				</td>
			</tr>
		</table>
	</form>
