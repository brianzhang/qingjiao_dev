...
<title>组织负责人选择</title>
<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmNodeDef/orgManagerDialog.js"></script>
...
<body  >
	<form id="orgManagerForm"  class="form-horizontal" >
		...
		<table class="table table-bordered"   cellspacing="1">
				...
				<td>
                    <div class="input-group">
                       	...
                       	<span class="input-group-btn">
                        	<button type="button" class="btn btn-primary" onclick="orgManagerDialog._choiceUser(this)"> 请选择</button> 
                       	</span>
                    </div>
				</td>
			</tr>
			...
			<tr >
				<th style="width:20%">
					<label for="nodeMan">相同节点执行人组织</label>
				...
				<td>
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                        <button type="button" class="btn btn-primary" onclick="orgManagerDialog._getNode(this)"> 请选择</button> 
                        </span>
                    </div>
				</td>
			</tr>
