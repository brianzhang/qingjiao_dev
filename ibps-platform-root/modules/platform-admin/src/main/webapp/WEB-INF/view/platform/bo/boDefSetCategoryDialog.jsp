...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/bo/boDefSetCategoryDialog.js"></script>
	</head>
	<body>
			...
			<form id="frmDel">
				<div class="form-group col-sm-12">
					...
					<div class="col-sm-10">
                        ...
                        <input type="text" class="form-control comboTree"  id="boType" name="boType" 
                                  data-toggle="comboTree"  data-type="BO_TYPE" data-id="#typeId"  readonly
                                  value="${boType}"  validate="{required:true}"/>
					</div>
				</div>
