...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/codegen/templateSetCategoryDialog.js"></script>
	</head>
	<body>
			...
			<form id="frmDel">
				<div class="form-group col-sm-12">
					...
					<div class="col-sm-10">
                        ...
                        <input type="text" class="form-control comboTree"  id="templateType" name="templateType" 
                                  data-toggle="comboTree"  data-type="TEMPLATE_TYPE" data-id="#typeId"  readonly
                                  value="${templateType}"  validate="{required:true}"/>
					</div>
				</div>
