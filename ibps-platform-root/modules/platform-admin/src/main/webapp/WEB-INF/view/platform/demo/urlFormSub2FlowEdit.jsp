	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			<div class="">
				...
				<div class="fr-selector" data-toggle="selector" data-type="" data-bind-id="m:urlFormSub2:"  data-single="">
				...
				<input type="text" readonly="readonly"  class="fr-form-control comboTree"
						 data-toggle="dictionary"   data-dic="" data-key="#name"
		                 value="${f:getDictLabel(urlFormSub2.name,'', 'key', '')}"  validate="{required:false}"/>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-6" >
