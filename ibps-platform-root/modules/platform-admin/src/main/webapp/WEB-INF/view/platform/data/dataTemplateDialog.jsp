...
<script type="text/javascript" src="${ctx}/js/lc/platform/data/dataTemplateSelector.js"></script>
</head>
<body>
	<div class="wrapper wrapper-content col-sm-12">
		<div class="selector-wrapper">
			<div  class ="selector-container" name="dataTemplate_container" ></div>
		</div>
		<div class="row">
			<div class="col-sm-12 ">
				...
				<div class="jqGrid_wrapper">
					<table id="dataTemplateGrid" ></table>
					<div id="dataTemplatePager"></div>
				</div>
			</div>
		</div>
	</div>
