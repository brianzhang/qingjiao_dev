...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmStatisticsRunningRaq.js"></script>
	</head>
	<body>
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form" action="${ctx}/platform/report/raqsoft/showReport.htm">
							<div  class="form-inline p-xxs">
								<input type="hidden" name="reportName" value="demo_statistics_running" />
								<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="input-group ">
												<input type="hidden" name="creator"  id="creatorId"  value=""/> 
...
<!-- 								</div> -->
			...
			<div class="report_wrapper">
				<iframe id="raqsoftFrame" src="${ctx }/platform/report/raqsoft/showReport.htm?reportName=demo_statistics_running" style="width:100%;border: 0px;"></iframe>
			</div>
			<!-- #分页条件-->
