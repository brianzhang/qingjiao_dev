	...
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/loanp/DaiKSSCSP/jingBRYJ/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/loanp/DaiKSSCSP/jingBRYJ/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/loanp/DaiKSSCSP/jingBRYJ/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label   class="search-label"> 贷款类型</label>:
									<input type="text"  name="Q^DKLX^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
								...
								<div class="form-group">
									<label   class="search-label">经办调查人Id</label>:
									<input type="text"  name="Q^JBDCRID^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">经办人签字</label>:
									<input type="text"  name="Q^JBRQZ^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label class="search-label">经办人签字时间 </label>:
									<input type="text" name="Q^JBRQZSJ^DL"  class="form-control date"  />
								</div>
								<div class="form-group">
									<label class="search-label" >至</label>:
									<input type="text" name="Q^JBRQZSJ^DG"  class="form-control date" />
								</div>
							</div>
						</form>
					</div><!--/ 查询条件-->
			...
			<div class="jqGrid_wrapper">
				<table id="jingBRYJGrid" ></table>
				<div id="jingBRYJPager"></div>
			</div>
		</div>
