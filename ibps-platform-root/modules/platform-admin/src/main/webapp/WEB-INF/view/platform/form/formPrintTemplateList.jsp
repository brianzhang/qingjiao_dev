...
<script type="text/javascript" src="${ctx}/js/lc/platform/form/formPrintTemplateList.js"></script>
<title>表单打印列表</title>
</head>
<body>
...
<div class="dashboard">
		<div class="dashboard-header">
              <h2 class="pull-left">表单打印模版</h2>
                          <div id="formPage" class="pull-right"></div>
                          
                      <input type="hidden" id="formKey"  name="Q^FORM_KEY_^S" value="${formKey}"/>
...
<ul class="dashboard-settings-options dropdown-menu" data-id="{{id}}"  data-key={{key}}>
    ...
    <li class="edit-template" >
      <a href="javascript:void(0)">
 	 	<i class="item-icon fa fa-edit"></i>
 	 	<span>编辑</span>
	  </a>
	</li>
    <li class="delete-template">
      	<a href="javascript:void(0)">
