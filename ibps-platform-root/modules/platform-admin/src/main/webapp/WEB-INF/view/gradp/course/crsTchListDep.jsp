				...
				<div class="toolbar-head clearfix">
					...
					<div class="buttons">
						...
						<a class="btn btn-primary fa fa-export" href="javascript:void(0);" ><span>导出课表</span></a>
						 <a class="btn btn-primary fa fa-upload" href="javascript:void(0);" id="importCrsTch"><span>导入授课表</span></a>
...
<script type="text/javascript" src="${ctx}/js/lc/gradp/course/crsTchDep.js"></script>
</html>
