...
<html>
	<head>
		...
		<title>流程定义耗时报表预览</title>
		<script type="text/javascript">
			var printPosition ='buttom';
		</script>
		<script type="text/javascript" src="${ctx}/js/plugins/artTemplate/artTemplate.js"></script>
		<script type="text/javascript" src="${ctx}/js/lc/platform/bpmn/bpmStatisticsTimeConsuming.js"></script>
	</head>
	<body>
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form" action="${ctx}/platform/report/raqsoft/showReport.htm">
							<div  class="form-inline p-xxs">
								<input type="hidden" name="reportName" value="demo_statistics_time_consuming" />
								<div class="form-group">
									<label class="search-label">时间维度</label>:
									<select id="dateType" class="form-control search-select">
...
<!-- 										<option value="day" >日</option> -->
								...
								<div class="form-group" id="createTime">
									...
									<input type="text" name="createTime" datefmt="yyyy-MM"  class="form-control datepicker" />
								</div>
								<div class="form-group" id="endTime">
									<label class="search-label" >至</label>:
									<input type="text" name="endTime" datefmt="yyyy-MM" class="form-control datepicker" />
								</div>
								<div class="form-group" >
									<label class="search-label">排序</label>:
									<select name="sort" class="form-control search-select">
										<option value="" ></option>
...
<!-- 								</div> -->
			...
			<div class="report_wrapper">
				<iframe id="raqsoftFrame" src="${ctx }/platform/report/raqsoft/showReport.htm?reportName=demo_statistics_time_consuming" style="width:100%;border: 0px;"></iframe>
			</div>
			<!-- #分页条件-->
