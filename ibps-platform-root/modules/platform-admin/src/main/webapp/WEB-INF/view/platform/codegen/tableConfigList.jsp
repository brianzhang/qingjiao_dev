	...
	<div class="ui-layout-west">
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/platform/codegen/tableConfig/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/platform/codegen/tableConfig/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/platform/codegen/tableConfig/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label   class="search-label">表注释</label>:
									<input type="text"  name="Q^table_comment_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">类名</label>:
									<input type="text"  name="Q^class_name_^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">主表表名</label>:
									<input type="text"  name="Q^parent_table_name_^SL"  class="form-control"  />
								</div> 
			...
			<div class="jqGrid_wrapper">
				<table id="tableConfigGrid" ></table>
				<div id="tableConfigPager"></div>
			</div>
		</div>
	</div>
