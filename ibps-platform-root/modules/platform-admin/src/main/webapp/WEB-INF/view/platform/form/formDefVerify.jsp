...
<html>
	...
	<body>
		<div class="ui-layout-west">
			...
			<div  class="niceScroll"   data-name="formVerify">
		...
		<div class="ui-layout-south" resizable="false">
				<form class="form-horizontal"  style="margin-top: 5px;">
						<div class="form-group">
                                <label class="col-sm-2 control-label">校验错误提示:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="msg" name="msg" value="${bpmForm.name}"  validate="{required:true,maxlength:64}"/>
                                </div>
                            </div>
                    </form>
		</div>
