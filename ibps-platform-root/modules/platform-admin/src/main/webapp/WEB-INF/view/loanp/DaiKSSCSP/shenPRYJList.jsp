	...
	<body>
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/loanp/DaiKSSCSP/shenPRYJ/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/loanp/DaiKSSCSP/shenPRYJ/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/loanp/DaiKSSCSP/shenPRYJ/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label   class="search-label">审批人Id</label>:
									<input type="text"  name="Q^SPRID^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label   class="search-label">审批人签名</label>:
									<input type="text"  name="Q^SPRQM^SL"  class="form-control"  />
								</div> 
								<div class="form-group">
									<label class="search-label">审批人签字时间 </label>:
									<input type="text" name="Q^SPRQZSJ^DL"  class="form-control date"  />
								</div>
								<div class="form-group">
									<label class="search-label" >至</label>:
									<input type="text" name="Q^SPRQZSJ^DG"  class="form-control date" />
								</div>
							</div>
						</form>
					</div><!--/ 查询条件-->
			...
			<div class="jqGrid_wrapper">
				<table id="shenPRYJGrid" ></table>
				<div id="shenPRYJPager"></div>
			</div>
		</div>
