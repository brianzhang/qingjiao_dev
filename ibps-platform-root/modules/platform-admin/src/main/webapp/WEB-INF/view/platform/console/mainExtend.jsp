...
<f:link href="mainExtend.css" isCommon="false"/>
<script type="text/javascript" src="${ctx}/js/plugins/ibps/ibps.min.js"></script>
<script type="text/javascript" src="${ctx}/js/lc/platform/console/mainExtend.js"></script>
		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<div class="navbar-brand">
					<c:choose>
						<c:when test="${curSubsystem.logoType == 'image'}"><img alt="子系统图标" src="${ctx }/styles/commons/images/logo/${curSubsystem.logo}" width="24px" height="24px"/></c:when>
						<c:otherwise> <i class="fa ${curSubsystem.logo}"></i> &nbsp;</c:otherwise>
					</c:choose>${curSubsystem.name}
				</div>
						...
						<ul class="user-menu dropdown-menu-right dropdown-menu dropdown-yellow dropdown-caret dropdown-close">
							...
							<li class="dropdown-hover">
								<a href="javascript:void(0);" class="clearfix">
									<span class="pull-left"><i class="ibps-icon fa fa-tags" style="margin-right: 9px;font-size: 110%"></i>切换系统</span>
									<i class="ibps-icon fa fa-caret-left pull-right"></i>
								</a>
								<c:if test="${subsystemList!=null}">
									<ul class="dropdown-menu dropdown-menu-right scrollable-nice" style="height:15em;">
										<c:forEach var="subsystem" items="${subsystemList}">
											<c:choose>
						            			<c:when test="${subsystem.id==curSubsystem.id }">
						            				<li class="disabled   grey-bg">
							...
							<li>
								<a href="javascript:void(0);" id="userSwitch" data-value="${cookie.origSwitch.value}">
