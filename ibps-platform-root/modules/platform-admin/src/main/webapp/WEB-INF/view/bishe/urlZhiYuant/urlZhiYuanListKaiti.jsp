...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/bishe/urlZhiYuant/urlZhiYuanKaiti.js"></script>
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-export" href="javascript:void(0);"><span>导出开题报告</span></a>
							<!-- <a class="btn btn-primary fa fa-edits" href="javascript:void(0);"><span>指定立题书审核人员</span></a>	  -->
					...
					<div class="toolbar-body" >
						<form role="form" class="search-form">
							<div  class="form-inline p-xxs">
								...
								<div class="form-group">
									<label   class="search-label">团队</label>:
									<input type="text"  name="Q^FINALTD^SL"  class="form-control"  />
								</div>  
								<div class="form-group">
