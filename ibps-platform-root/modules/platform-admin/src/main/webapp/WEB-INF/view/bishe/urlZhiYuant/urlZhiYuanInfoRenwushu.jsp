	...
	<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
		<%-- <div class="panel-toolbar ">
			<div class="buttons">
             ...
             <a id="view2"class="btn btn-primary fa fa-edit "  href="${ctx}/bishe/oldFile/oldFile/list.htm?id=${urlZhiYuan.id}"><span >查看历史审批文件</span></a> 
			</div>
		</div> --%>
		<div class="">
			<form class="fr-form" id="urlZhiYuanForm" action="save.htm">
			<h2>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp下载任务书</h2>
			</br>
