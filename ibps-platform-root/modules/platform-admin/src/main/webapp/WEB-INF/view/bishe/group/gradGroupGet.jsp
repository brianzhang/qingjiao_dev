...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<p class="form-control-static">${gradGroup.createBy}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">创建时间</label>
				  	<div class="fr-form-block">
							<p class="form-control-static"><fmt:formatDate value="${gradGroup.createTime}" /></p>		
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">更新人</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${gradGroup.updateBy}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">更新时间</label>
				  	<div class="fr-form-block">
							<p class="form-control-static"><fmt:formatDate value="${gradGroup.updateTime}" /></p>		
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">日期</label>
				  	<div class="fr-form-block">
							<p class="form-control-static"><fmt:formatDate value="${gradGroup.date_}" /></p>		
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">时间</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${gradGroup.time_}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">地点</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${gradGroup.place_}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">名称</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${gradGroup.name_}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			...
			<p class="form-control-static">${gradGroup.type_}</p>
			 	...
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">组长</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${gradGroup.leader_}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
