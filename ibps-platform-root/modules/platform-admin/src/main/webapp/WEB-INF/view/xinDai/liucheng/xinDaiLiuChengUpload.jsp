...
<html>
	...
	<body>
		...
		<!--
			...
			<div class="">
				          <iframe id="iframe1"  name="iframe1"  width="100%" height="800px" frameborder=no  border=0  marginwidth=0  marginheight=0  scrolling=no src="${ctx}/loanp/files/file/list.htm?loanId=${xinDaiLiuCheng.id}&ty=0"></iframe>			
	        </div
</form>
