...
<html>
	...
	<body>
		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="">
					<form  class="fr-form"  id="applyMoneyForm" >
				 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">信用社</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${applyMoney.xys}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">客户名</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${applyMoney.customer}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">身份证号</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${applyMoney.sfid}</p>
				 	</div>
			  	</div>
			</div>
			 	<div class="fr_response_field col-sm-12" >
			 	<div class="fr-form-group"> 
				 	<label class="fr-control-label">贷款类别</label>
				  	<div class="fr-form-block">
			<p class="form-control-static">${applyMoney.dklb}</p>
				 	</div>
			  	</div>
			</div>
	</form>
