		...
		<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
			...
			<div class="tabs-container tabs-x" data-flexheight="55" >
                   <ul class="nav nav-tabs">
                       <li class="active">
                       		<a href="#flowInfo"   data-url="${ctx }/platform/bpmn/instance/bpmInst/get.htm?id=${id}"  data-toggle="tab"    data-iframe="true">流程信息</a>
                       </li>
                       <li class="">
                       		<a  href="#flowImage" data-url="${ctx }/platform/bpmn/instance/bpmInst/flowImage.htm?id=${id}&isEnd=${isEnd}"   data-toggle="tab"  data-iframe="true" >流程图</a>
                       	</li>
<%--                        <li class="">
