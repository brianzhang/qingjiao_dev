...
<html>
	...
	<body>
		...
		<div class="panel-toolbar ">
				<div class="buttons">
					<a href="${ctx}/loanp/DaiKSSCSP/zhuDCRYJ/edit.htm?jdid=${xinDaiLiuCheng.id} " class="btn btn-primary fa " ><span>审批意见</span></a>
				</div>
			</div>
			<div class="">
			...
			<div class="fr_response_field col-sm-2" >
			 	...
			 	<label class="fr-control-label">选择审核人</label>
				 	<select name="m:xinDaiLiuCheng:wj">
				 	              <option value ="0"  selected = "selected">请选择</option>
				 			<c:forEach items="${userBs}" var="u">
			...
			<div class="">
				          <iframe id="iframe1"  name="iframe1"  width="100%" height="800px" frameborder=no  border=0  marginwidth=0  marginheight=0  scrolling=no src="${ctx}/loanp/demo/demoLoan/list.htm?jdid=${xinDaiLiuCheng.id}"></iframe>			
	        </div
