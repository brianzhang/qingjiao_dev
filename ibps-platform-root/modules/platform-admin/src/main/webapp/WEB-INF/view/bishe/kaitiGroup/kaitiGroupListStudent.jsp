...
<html>
	<head>
		...
		<script type="text/javascript" src="${ctx}/js/lc/bishe/kaitiGroup/kaitiGroupStudent.js"></script>
				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<!-- <a class="btn btn-primary fa fa-detail" href="javascript:void(0);" id="ktqk" ><span>学生开题情况记录</span></a> -->
