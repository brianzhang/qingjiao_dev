						...
						<div class="parent-template-class">
							<div class="dashboard-container" template-alias="dashboard">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 g-btn">
									<a class="dashboard dashboard-stat blue"
										href="/gradp/practise/main/home.htm">
										<div class="visual">
											<i class="fa fa-comments"></i>
										</div>
										<div class="details">
											<div class="desc">实习实训管理系统</div>
										</div>
									</a>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 g-btn">
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 g-btn">
									<a class="dashboard dashboard-stat green-meadow" data-url=""
										href="javascript:void(0);">
										<div class="visual">
											<i class="fa fa-file-o"></i>
										</div>
										<div class="details">
											<div class="desc">选修作业管理系统</div>
										</div>
									</a>
								</div>
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 g-btn">
									<a class="dashboard dashboard-stat blue-madison" data-url=""
										href="javascript:void(0);">
										<div class="visual">
											<i class="fa fa-hand-o-up"></i>
										</div>
										<div class="details">
											<div class="desc">实验报告管理系统</div>
										</div>
									</a>
								</div>
							</div>
