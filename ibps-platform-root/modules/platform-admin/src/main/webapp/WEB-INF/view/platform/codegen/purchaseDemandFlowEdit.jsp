...
<html>
	...
	<body>
		...
		<table name="s:" data-mode="inner" data-required="" class="table table-bordered table-hover table-condensed">
			...
			<tbody>	
				<c:forEach varStatus="stat" var="" items="${purchaseDemand.PoList}">	
					<tr>	
						<td><input role="checkbox" class="cbox " type="checkbox" name="s:" ></td>
				 		<td>
							
				<input type="text" class="fr-form-control" name="s::purchaseItem:${stat.index+1}" value="${.purchaseItem}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<input type="text" class="fr-form-control" name="s::purItemName:${stat.index+1}" value="${.purItemName}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<input type="number"  class="fr-form-control"  name="s::purchaseNumber:${stat.index+1}"  value="${.purchaseNumber}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<input type="number"  class="fr-form-control"  name="s::marketRefePrice:${stat.index+1}"  value="${.marketRefePrice}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<input type="number"  class="fr-form-control"  name="s::subtotal:${stat.index+1}"  value="${.subtotal}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<div class="input-icon" >
					<i class="fa fa-calendar"></i>
					<input type="text" readonly="readonly" class="fr-form-control datepicker" datefmt="yyyy-MM-dd"   name="s::demandDate:${stat.index+1}"   value="${.demandDate}" validate="{required:false}"/>
				</div>
												</td>	
				 		<td>
							
				<input type="text" class="fr-form-control" name="s::description:${stat.index+1}" value="${.description}" validate="{required:false}"/>
												</td>	
				 		<td>
				...
				<input type="text" class="fr-form-control" name="s::operator:${stat.index+1}" value="${.operator}" validate="{required:false}"/>
												</td>	
	...
	<script type="text/html" id="s::TrTemplate">
		...
		<table name="s:" data-mode="inner" data-required="" class="table table-bordered table-hover table-condensed">
			...
			<tbody>	
				...
				<input type="text" class="fr-form-control" name="s::documentName:${stat.index+1}" value="${.documentName}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<input type="text" class="fr-form-control" name="s::selectAttachment:${stat.index+1}" value="${.selectAttachment}" validate="{required:false}"/>
												</td>	
				 		<td>
							
				<textarea class="fr-form-control fr-control-textarea"  name="s::remark:${stat.index+1}"  validate="{required:false}">${.remark}</textarea>
												</td>	
						<td class="fr_table_col_remove" width="45px">
