...
<body>
	<div class="wrapper wrapper-content  animated fadeInRight col-sm-12">
	   ...
	   <div class="panel-form">
	   		<form class="form-horizontal" id="getBpmAuthForm"  action="save.htm"   method="post"  >
      				...
      				<div class="form-group">
                         ...
                         <div class="col-sm-10">
                             <input type="text" readonly class="form-control"  id="name" name="name" value="${bpmAuth.name}"  validate="{required:true,maxlength:192}"/>
                         </div>
                     </div>
                     <div class="form-group">
