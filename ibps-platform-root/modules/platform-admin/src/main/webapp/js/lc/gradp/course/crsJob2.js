	...
	CrsJob.prototype = {
		...
		_initGridList: function() {
			...
			$(this.consts.GRID).GridList({
				url: __ctx + "/gradp/course/crsJob/listJson2.htm?crsTchId="+crsTchId,
					...
					formatoptions : [
						{
							...
							hidden:!shenyue,
							action : __ctx+'/gradp/course/jobStd/listStds2.htm?scorePower={scorePower}&jobID={id}&jobName={title}&crsTchId='+crsTchId+'&crsName='+crsName
						}]
				}
