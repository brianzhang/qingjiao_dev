var bpmDefineSetCategoryDialog;
$(function() {
	bpmDefineSetCategoryDialog = new BpmDefineSetCategoryDialog();
	bpmDefineSetCategoryDialog.init();
});
...
(function() {
	 ...
	 * @returns {BpmForm}
	 */
	BpmDefineSetCategoryDialog = function() {
		// 定义属性
	};
	 ...
	 * 方法
	 */
	BpmDefineSetCategoryDialog.prototype = {
		consts : _consts,
		/**
		 * 初始化
		 */
