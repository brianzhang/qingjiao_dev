	...
	UrlZhiYuan.prototype = {
		...
		_bindBtns : function(){
			...
			$(document).on('click', 'a.fa-caret-square-o-right', function () {
                ...
                $.post(url, {'id': ids.join(','), 'flowKey':'Process_1hvs9bf'}, function (responseText) {
		...
		_initGridList : function() {
			...
			$(this.consts.GRID).GridList(
					{
						url :  __ctx+'/bishe/kaitiGroup/kaitiGroup/student.htm',
				        ...
				        colModel: [{
								  ...
								  formatoptions :[{
									    ...
									    classes:'btn btn-primary fa fa-edit',
									 	action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/studentLitishu2.htm?type=1&id={id}'
						  														},{
						           		label:'立题书查看',
						            	classes:'btn btn-primary fa fa-edit',
						           		action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/studentLitishu2.htm?type=0&id={id}'
						                								},{
						             label:'开题情况记录',
