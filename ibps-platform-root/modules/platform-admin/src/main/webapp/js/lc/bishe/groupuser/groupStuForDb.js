...
(function() {
	...
	groupStu.prototype = {
				...
				$(this.consts.GRID).GridList(
						{
					        ...
					        colModel: [{
									  ...
									  formatoptions :[{
							             ...
							             //action:'javascript:groupStu.editDbGrade( "{id}" )'
                                          action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/dbGrade.htm?id={id}'
							            						                								}]
							                															}],
        ...
        // editDbGrade : function( id ){
		// 	debugger
		// 	var subjectUrl = __ctx + "/bishe/urlZhiYuant/urlZhiYuan/dbGrade.htm";
         //    $.ajax({
         //        type: "POST",
         //        dataType:"json",
         //        url:subjectUrl,
		...
		_showResponse : function(responseText) {
			...
			if (msg.isSuccess()) {
                ...
                window.location.href = __ctx+'/bishe/groupuser/groupUser/leaderManageStuForDb.htm?type=2';
