$(function() {
	bpmStatisticsTimeConsuming = new BpmStatisticsTimeConsuming();
	bpmStatisticsTimeConsuming.init();
});
...
(function() {
	 ...
	 * @returns {ReportDef}
	 */
	BpmStatisticsTimeConsuming = function() {
	 ...
	 * 方法
	 */
	BpmStatisticsTimeConsuming.prototype = {
		consts : _consts,
		/**
		 * 初始化
		 */
