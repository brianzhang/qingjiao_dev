	...
	CrsJob.prototype = {
		...
		_initGridList: function() {
			...
			$(this.consts.GRID).GridList({
				url: __ctx + "/gradp/course/crsJob/listJson.htm?crsTchId="+crsTchId,
					...
					formatoptions : [
						{
							...
							hidden:!shenyue,
							action : __ctx+'/gradp/course/jobStd/listStds.htm?scorePower={scorePower}&jobID={id}&jobName={title}&crsTchId='+crsTchId+'&crsName='+crsName
                            //action : __ctx+'/gradp/course/jobStd/list.htm'
						}]
				}
