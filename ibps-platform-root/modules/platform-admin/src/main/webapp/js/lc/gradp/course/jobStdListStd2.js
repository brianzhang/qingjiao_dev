...
(function() {
	...
	jobStdListStd.prototype = {
		...
		_initGridList : function() {
			var a = this,grid = $(this.consts.GRID);
					grid.GridList(
							{
								url : __ctx
										+ '/gradp/course/jobStd/listStdsJson2.htm?crsTchId='+crsTchId+'&jobID='+jobID+'&crsName='+crsName,
		...
		listJob : function(stdNum,stdName,id) {
			//var url =  __ctx+'/gradp/course/jobStd/markScore2.htm?jobId='+jobID+'&title='+jobName+'&stdNum='+stdNum+'&crsTchId='+crsTchId;
            //var url =  __ctx+'/gradp/course/jobStd/markScore.htm?jobId='+jobID+'&role='+'123'+'&title='+jobName+'&stdNum='+stdNum+'&crsTchId='+crsTchId;
            var url =  __ctx+'/gradp/course/jobStd/markScore.htm?jobId='+jobID+'&role='+'123'+'&title='+jobName+'&stdNum='+stdNum+'&stdName='+stdName+'&crsTchId='+crsTchId;
            //var url =  __ctx+'/gradp/course/jobStd/markScore.htm?title='+jobName+'&stdNum='+stdNum+'&crsTchId='+crsTchId;
			DialogUtil.dialog({
