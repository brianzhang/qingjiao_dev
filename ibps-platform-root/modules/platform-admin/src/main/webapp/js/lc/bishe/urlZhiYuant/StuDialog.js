					...
					area:['60%','80%'],
					 btn:[{
			                ...
			                action: function(dialog,index) {
			              	  var  data = DialogUtil.getChildFrameWindow(index).stuSelector.getData();
			              	  if($.isEmpty(data)){
			            ...
			            },
			            {
			                ...
			                action: function(dialog,index) {
			                	...
			                	$.each(data, function(i, content) {
			                		DialogUtil.getChildFrameWindow(index).stuSelector.remove(content.id,content.account);
			                	});
