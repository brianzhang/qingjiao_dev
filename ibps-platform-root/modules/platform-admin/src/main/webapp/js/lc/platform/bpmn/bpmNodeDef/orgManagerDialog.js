 ...
 * </pre>
 */
var orgManagerDialog;
var data = frameElement.dialog.params;
$(function() {
	orgManagerDialog  = new OrgManagerDialog();
	orgManagerDialog.init();
});

(function() {
	//定义常量
	var 	_consts = {
			FORM : "#orgManagerForm",// 表单对象
	};
	/**
	 * 
	 * @returns {OrgManagerDialog}
	 */
	OrgManagerDialog = function() {
		//定义属性
