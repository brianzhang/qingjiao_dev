		...
		_initGridList : function() {
			var a = this,grid = $(this.consts.GRID);
					grid.GridList(
							{
								url : __ctx
										+ '/gradp/course/crsTch/listMyStudentsJsonPG.htm'								,
								rowNum:100,
											...
											formatoptions : [
													{
														...
														classes : 'btn btn-primary fa fa-edit',
										           		//action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/studentLitishu2PG.htm?type=0&id={id}'
														action:'javascript:pageOffice( "{litishufile}" )'
													},{
														label : ' 任务书',
														classes : 'btn btn-primary fa fa-edit',
													 	//action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/studentLitishu2PG.htm?type=1&id={id}'
														action:'javascript:pageOffice( "{renwushufile}" )'
													},{
														label : ' 开题报告',
														classes : 'btn btn-primary fa fa-edit',
										           		//action:__ctx+'/bishe/urlZhiYuant/urlZhiYuan/studentLitishu2PG.htm?type=2&id={id}'
														action:'javascript:pageOffice( "{kaitifile}" )'
													},{
														label : ' 开题情况记录',
														classes : 'btn btn-primary fa fa-edit',
											            //action:'javascript:urlZhiYuan.onlineForm( "{id}" )'
														action:'javascript:crsTchListMyStudents.onlineForm( "{id}" )'
													},{
														label : ' 中期情况记录',
														classes : 'btn btn-primary fa fa-edit',
											            //action:'javascript:urlZhiYuan.onlineForm( "{id}" )'
														action:'javascript:crsTchListMyStudents.onlineForm1( "{xh}" )'
													},{
														label : ' 其他',
														classes : 'btn btn-primary fa fa-edit',                                //
														//action : __ctx+'/gradp/course/crsJob/listPG.htm?xh={xh}&crsTchid='+'2014liuxibysj'
														action : 'javascript:crsTchListMyStudents.open("'+__ctx+'/gradp/course/jobStd/markScore.htm?role=tch&stdNum={xh}&crsTchId='+'2014liuxibysj'+'&stdName={name}&crsName='+crsName.replaceAll('<s.*n>','')+'")'
															}]
										}],
