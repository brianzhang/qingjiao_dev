var boDefSetCategoryDialog;
$(function() {
	boDefSetCategoryDialog = new BoDefSetCategoryDialog();
	boDefSetCategoryDialog.init();
});
...
(function() {
	 ...
	 * @returns {BpmForm}
	 */
	BoDefSetCategoryDialog = function() {
		// 定义属性
	};
	 ...
	 * 方法
	 */
	BoDefSetCategoryDialog.prototype = {
		consts : _consts,
		/**
		 * 初始化
		 */
