	...
	UrlZhiYuan.prototype = {
			...
			$(this.consts.GRID).GridList(
					{
						...
						colNames: ['主键','班级','学号','姓名','所属团队','所属教师','立题书审核人','流程是否已启动'],
				        colModel: [{
				                 	   name:'id',
				                	   index: 'id_'
        ...
        _bindExportBtns : function(){
            ...
            $(document).on('click', 'a.fa-export', function () {
                var url = __ctx + "/bishe/urlZhiYuant/urlZhiYuan/getLiTISHU.htm" ;
			...
			if (msg.isSuccess()) {
				DialogUtil.confirm(msg.getMessage() + ',是否继续操作',
						...
						if(rtn)
							...
							window.location.href = __ctx+'/bishe/urlZhiYuant/urlZhiYuan/list2.htm';
						});
			} else {
				DialogUtil.error(msg.getMessage());
			}
