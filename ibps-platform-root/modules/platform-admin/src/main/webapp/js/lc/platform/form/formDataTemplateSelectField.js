 ...
 */
$(function() {
	formDataTemplateSelectField = new FormDataTemplateSelectField();
	formDataTemplateSelectField.init();
});
...
(function() {
	...
	/**
	 * 导出字段勾选 对象
	 * @returns {FormDataTemplateSelectField}
	 */
	FormDataTemplateSelectField = function() {
		this.trTemplate = '\
					...
					<td>\
						<label class="checkbox-inline">\
							...
							<input type="hidden" class="type" name="type_{{= it.idx}}" value="{{= it.field_type}}">\
				       	 	...
				       	 	<span class="lbl">{{= it.showName}}</span>\
		                 </label>\
					</td>\
				</tr>';
	 ...
	 * 方法
	 */
	FormDataTemplateSelectField.prototype = {
		consts:	_consts,
		/**
		 * 初始化
		 */
