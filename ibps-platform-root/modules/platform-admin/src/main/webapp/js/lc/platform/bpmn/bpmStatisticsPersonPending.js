$(function() {
	bpmStatisticsPersonPending = new BpmStatisticsPersonPending();
	bpmStatisticsPersonPending.init();
});
...
(function() {
	 ...
	 * @returns {ReportDef}
	 */
	BpmStatisticsPersonPending = function() {
	 ...
	 * 方法
	 */
	BpmStatisticsPersonPending.prototype = {
		consts : _consts,
		/**
		 * 初始化
		 */
		...
		_initDepartSelect: function(){
			var $orgList = orgList,option="";
