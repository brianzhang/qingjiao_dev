				...
				<div class="toolbar-box">
					<div class="toolbar-head clearfix">
						...
						<div class="buttons"> 		
							...
							<a class="btn btn-primary fa fa-add"   href="${ctx}/components/report/ireport/reportField/edit.htm" ><span>添加</span></a>
					        <a class="btn btn-primary fa fa-edit"   href="javascript:void(0);"  action="${ctx}/components/report/ireport/reportField/edit.htm" ><span>编辑</span></a>	 
					        <a class="btn btn-primary fa fa-remove" href="javascript:void(0);"  action="${ctx}/components/report/ireport/reportField/remove.htm"><span>删除</span></a>
						</div>
						<!-- 收缩 -->
						<div class="tools">
