...
public class PageResult implements java.io.Serializable {
	...
	public static PageResult fromJson(String json){
		Map<String, Object> data = JacksonUtil.toMap(json);
		int page = Integer.valueOf((data.get("page")==null?0:data.get("page")).toString());
		int limit = Integer.valueOf((data.get("limit")==null?0:data.get("limit")).toString());
		int totalCount = Integer.valueOf((data.get("totalCount")==null?0:data.get("totalCount")).toString());
		
		return new PageResult(page, limit, totalCount);
	}
